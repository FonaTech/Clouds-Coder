...
# split-source: order=93 original-lines=531-534 hash=60317e63d1c028ef


def _now() -> float:
    return time.time()

# split-source: order=94 original-lines=535-538 hash=1929f0af1ffc0b2d


def _json(value: Any) -> str:
    return json.dumps(value, ensure_ascii=False, separators=(",", ":"), sort_keys=True)

# split-source: order=95 original-lines=539-545 hash=4d410ba2e075a890
...
# split-source: order=96 original-lines=546-549 hash=ee6e3653cf3898c4


def _b64_token(prefix: str, size: int = 32) -> str:
    return prefix + base64.urlsafe_b64encode(os.urandom(size)).decode("ascii").rstrip("=")

# split-source: order=97 original-lines=550-558 hash=54ad7c4545192550
...
# split-source: order=98 original-lines=559-562 hash=2b8af246a2e07ed0


def _digest(value: str) -> str:
    return hashlib.sha256(str(value or "").encode("utf-8")).hexdigest()

# split-source: order=99 original-lines=563-566 hash=5c84a9c0388fcce5
...
# split-source: order=100 original-lines=567-576 hash=0525df69846b9be1
...
# split-source: order=101 original-lines=577-583 hash=329b30d8a2be6900
...
# split-source: order=102 original-lines=584-595 hash=092b9f914018d781
...
# split-source: order=103 original-lines=596-626 hash=2d23dac2c6735cfc
...
# split-source: order=104 original-lines=627-651 hash=ad6d495fc71aed76
...
# split-source: order=105 original-lines=652-659 hash=51b883f33dda370a
...
# split-source: order=106 original-lines=660-666 hash=6eb8f9562e1f2200
...
# split-source: order=107 original-lines=667-685 hash=08744832f0f0ecd9
...
# split-source: order=108 original-lines=686-693 hash=bd214df5d5a036c1
...
# split-source: order=109 original-lines=694-704 hash=fe2f6acbc02ca7ca
...
# split-source: order=110 original-lines=705-738 hash=2740907bbb62a91d
...
# split-source: order=111 original-lines=739-742 hash=ff8931b270bdbeb2
...
# split-source: order=112 original-lines=743-765 hash=fb2948399a8203a2
...
# split-source: order=113 original-lines=766-842 hash=2f8e90d05f10f763
...
# split-source: order=114 original-lines=843-3558 hash=df104ac8f441e453
...
# split-source: order=115 original-lines=3559-3772 hash=a9249a04c1992b57
