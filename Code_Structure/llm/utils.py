...
# split-source: order=846 original-lines=12103-12117 hash=b6bc62480e297d33
...
# split-source: order=847 original-lines=12118-12121 hash=809c5486e3290434
...
# split-source: order=848 original-lines=12122-12123 hash=5336afa576b84f38

_OLLAMA_TAG_CACHE_LOCK = threading.Lock()

# split-source: order=849 original-lines=12124-12124 hash=0e9c32a2e7390246
_OLLAMA_TAG_CACHE: dict[str, dict] = {}

# split-source: order=852 original-lines=12133-12171 hash=027209aa5e1968b3
...
# split-source: order=855 original-lines=12188-12232 hash=869060a204c81ba4
...
# split-source: order=856 original-lines=12233-12235 hash=84300145b305a8f9

def strip_thinking_content(text: str) -> str:
    return split_thinking_content(text)[0]

# split-source: order=857 original-lines=12236-12261 hash=dcb58a8b1e81d434
...
# split-source: order=858 original-lines=12262-12276 hash=0e6bd9e34bd84ee7
...
# split-source: order=859 original-lines=12277-12308 hash=e1a3cc4af04a7227
...
# split-source: order=860 original-lines=12309-12327 hash=593b4b2efdfdfc26
...
# split-source: order=861 original-lines=12328-12347 hash=5e190838582bfe71
...
# split-source: order=862 original-lines=12348-12365 hash=94d20ab520ec1fcb
...
# split-source: order=866 original-lines=12407-12417 hash=5cd2e8ebe2b3c672
...
# split-source: order=875 original-lines=12512-12514 hash=35e7f0d901bff49a
...
# split-source: order=876 original-lines=12515-12517 hash=13cd547ebeda1f0d
...
# split-source: order=890 original-lines=12572-12583 hash=18bd1763e9c788d2
...
# split-source: order=891 original-lines=12584-12620 hash=e46f2d8721997de2
...
# split-source: order=893 original-lines=12672-12684 hash=621dda42895b6558
...
# split-source: order=894 original-lines=12685-12718 hash=1abf019732b65984
...
# split-source: order=896 original-lines=12754-12768 hash=a7f49e844678d507
...
# split-source: order=897 original-lines=12769-12786 hash=cf2e2cc8977a7264
