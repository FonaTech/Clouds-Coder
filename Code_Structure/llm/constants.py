...
# split-source: order=63 original-lines=81-81 hash=1193ac432052a5ff
DEFAULT_OLLAMA_BASE_URL = os.getenv("OLLAMA_BASE_URL", "http://127.0.0.1:11434")

# split-source: order=64 original-lines=82-82 hash=e498053827490a72
DEFAULT_OLLAMA_MODEL = os.getenv("OLLAMA_MODEL", "qwen2.5-coder:7b")

# split-source: order=696 original-lines=7045-7054 hash=9a445aba4f015d9d
...
# split-source: order=697 original-lines=7055-7056 hash=17e3a31f65cff18b

OPENAI_LIKE_PROVIDER_NAMES = OPENAI_COMPAT_PROVIDER_NAMES | {"custom_http"}

# split-source: order=700 original-lines=7063-7074 hash=d6ecf69b7361bfa0
...
# split-source: order=701 original-lines=7075-7075 hash=0c5d5bfdf97a19e9
EFFORT_LOW = "low"

# split-source: order=702 original-lines=7076-7076 hash=b5439b37fab58e00
EFFORT_MEDIUM = "medium"

# split-source: order=703 original-lines=7077-7077 hash=82e662cb132aaefa
EFFORT_HIGH = "high"

# split-source: order=704 original-lines=7078-7078 hash=01bd36c88de4589d
EFFORT_MAX = "max"

# split-source: order=705 original-lines=7079-7079 hash=6460246751e15557
EFFORT_LEVELS = (EFFORT_OFF, EFFORT_LOW, EFFORT_MEDIUM, EFFORT_HIGH, EFFORT_MAX)

# split-source: order=706 original-lines=7080-7080 hash=0938bc0fa1221788
EFFORT_ORDER = {name: idx for idx, name in enumerate(EFFORT_LEVELS)}

# split-source: order=707 original-lines=7081-7081 hash=1559f599104bb115
EFFORT_DEFAULT = EFFORT_MEDIUM

# split-source: order=708 original-lines=7082-7089 hash=6f464f1a4b2eee46
...
# split-source: order=709 original-lines=7090-7096 hash=9639aada761e4a0e
...
# split-source: order=710 original-lines=7097-7106 hash=af4090d39855aa3c
...
# split-source: order=711 original-lines=7107-7112 hash=28ad6e40a67252b2
...
# split-source: order=712 original-lines=7113-7116 hash=bd8afbd1d4cf64d1
