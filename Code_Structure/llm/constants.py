...
# split-source: order=125 original-lines=3917-3917 hash=1193ac432052a5ff
DEFAULT_OLLAMA_BASE_URL = os.getenv("OLLAMA_BASE_URL", "http://127.0.0.1:11434")

# split-source: order=126 original-lines=3918-3918 hash=e498053827490a72
DEFAULT_OLLAMA_MODEL = os.getenv("OLLAMA_MODEL", "qwen2.5-coder:7b")

# split-source: order=881 original-lines=12721-12730 hash=9a445aba4f015d9d
...
# split-source: order=882 original-lines=12731-12732 hash=17e3a31f65cff18b

OPENAI_LIKE_PROVIDER_NAMES = OPENAI_COMPAT_PROVIDER_NAMES | {"custom_http"}

# split-source: order=885 original-lines=12739-12750 hash=d6ecf69b7361bfa0
...
# split-source: order=886 original-lines=12751-12751 hash=0c5d5bfdf97a19e9
EFFORT_LOW = "low"

# split-source: order=887 original-lines=12752-12752 hash=b5439b37fab58e00
EFFORT_MEDIUM = "medium"

# split-source: order=888 original-lines=12753-12753 hash=82e662cb132aaefa
EFFORT_HIGH = "high"

# split-source: order=889 original-lines=12754-12754 hash=01bd36c88de4589d
EFFORT_MAX = "max"

# split-source: order=890 original-lines=12755-12755 hash=6460246751e15557
EFFORT_LEVELS = (EFFORT_OFF, EFFORT_LOW, EFFORT_MEDIUM, EFFORT_HIGH, EFFORT_MAX)

# split-source: order=891 original-lines=12756-12756 hash=0938bc0fa1221788
EFFORT_ORDER = {name: idx for idx, name in enumerate(EFFORT_LEVELS)}

# split-source: order=892 original-lines=12757-12757 hash=1559f599104bb115
EFFORT_DEFAULT = EFFORT_MEDIUM

# split-source: order=893 original-lines=12758-12765 hash=6f464f1a4b2eee46
...
# split-source: order=894 original-lines=12766-12772 hash=9639aada761e4a0e
...
# split-source: order=895 original-lines=12773-12782 hash=af4090d39855aa3c
...
# split-source: order=896 original-lines=12783-12788 hash=28ad6e40a67252b2
...
# split-source: order=897 original-lines=12789-12792 hash=bd8afbd1d4cf64d1
