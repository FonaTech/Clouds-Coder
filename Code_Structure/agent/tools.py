...
# split-source: order=973 original-lines=17089-17122 hash=494ce756bc5b35d8
...
# split-source: order=974 original-lines=17123-17128 hash=4bfe2fe5ea6ce1a8
...
# split-source: order=1047 original-lines=28758-28771 hash=f19c222e839c27ec
...
# split-source: order=1048 original-lines=28772-29319 hash=4b2f915df6112fcb
...
# split-source: order=1049 original-lines=29320-29321 hash=3ee29b226eaf3576

TOOL_REQUIRED_ARGS: dict[str, list[str]] = {}

# split-source: order=1050 original-lines=29322-29322 hash=08ea091c248842a3
TOOL_SPEC_BY_NAME: dict[str, dict] = {}

# split-source: order=1051 original-lines=29323-29332 hash=5b49546953f9369c
for _tool in TOOLS:
    try:
...
# split-source: order=1052 original-lines=29333-29334 hash=bfed07d2aedc6126

TOOL_NAME_FUZZY_MAP: dict[str, str] = {}

# split-source: order=1053 original-lines=29335-29338 hash=61dd6436d3455b98
...
# split-source: order=1054 original-lines=29339-29356 hash=8c7992dc17a67107
...
# split-source: order=1055 original-lines=29357-29373 hash=a168e414b363725e
...
# split-source: order=1056 original-lines=29374-29392 hash=b3e6ffc2768f20fa
...
# split-source: order=1057 original-lines=29393-29408 hash=b445806005f59898
...
# split-source: order=1058 original-lines=29409-29419 hash=9ed4253b5af25719
...
# split-source: order=1059 original-lines=29420-29483 hash=c3efb64c9011ad20
