...
# split-source: order=921 original-lines=26515-26528 hash=f19c222e839c27ec
...
# split-source: order=922 original-lines=26529-27055 hash=06fb072ba785b90b
...
# split-source: order=923 original-lines=27056-27057 hash=3ee29b226eaf3576

TOOL_REQUIRED_ARGS: dict[str, list[str]] = {}

# split-source: order=924 original-lines=27058-27058 hash=08ea091c248842a3
TOOL_SPEC_BY_NAME: dict[str, dict] = {}

# split-source: order=925 original-lines=27059-27068 hash=5b49546953f9369c
for _tool in TOOLS:
    try:
...
# split-source: order=926 original-lines=27069-27070 hash=bfed07d2aedc6126

TOOL_NAME_FUZZY_MAP: dict[str, str] = {}

# split-source: order=927 original-lines=27071-27074 hash=61dd6436d3455b98
...
# split-source: order=928 original-lines=27075-27092 hash=8c7992dc17a67107
...
# split-source: order=929 original-lines=27093-27109 hash=a168e414b363725e
...
# split-source: order=930 original-lines=27110-27128 hash=b3e6ffc2768f20fa
...
# split-source: order=931 original-lines=27129-27144 hash=b445806005f59898
...
# split-source: order=932 original-lines=27145-27155 hash=9ed4253b5af25719
...
# split-source: order=933 original-lines=27156-27219 hash=c3efb64c9011ad20
