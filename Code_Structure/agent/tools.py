...
# split-source: order=973 original-lines=17088-17121 hash=494ce756bc5b35d8
...
# split-source: order=974 original-lines=17122-17127 hash=4bfe2fe5ea6ce1a8
...
# split-source: order=1047 original-lines=28757-28770 hash=f19c222e839c27ec
...
# split-source: order=1048 original-lines=28771-29318 hash=4b2f915df6112fcb
...
# split-source: order=1049 original-lines=29319-29320 hash=3ee29b226eaf3576

TOOL_REQUIRED_ARGS: dict[str, list[str]] = {}

# split-source: order=1050 original-lines=29321-29321 hash=08ea091c248842a3
TOOL_SPEC_BY_NAME: dict[str, dict] = {}

# split-source: order=1051 original-lines=29322-29331 hash=5b49546953f9369c
for _tool in TOOLS:
    try:
...
# split-source: order=1052 original-lines=29332-29333 hash=bfed07d2aedc6126

TOOL_NAME_FUZZY_MAP: dict[str, str] = {}

# split-source: order=1053 original-lines=29334-29337 hash=61dd6436d3455b98
...
# split-source: order=1054 original-lines=29338-29355 hash=8c7992dc17a67107
...
# split-source: order=1055 original-lines=29356-29372 hash=a168e414b363725e
...
# split-source: order=1056 original-lines=29373-29391 hash=b3e6ffc2768f20fa
...
# split-source: order=1057 original-lines=29392-29407 hash=b445806005f59898
...
# split-source: order=1058 original-lines=29408-29418 hash=9ed4253b5af25719
...
# split-source: order=1059 original-lines=29419-29482 hash=c3efb64c9011ad20
