...
# split-source: order=934 original-lines=27220-27228 hash=9e668c7c3fcbd2dc
...
# split-source: order=935 original-lines=27229-27229 hash=6fd3520014763931
_IDE_SANDBOX_BACKEND_LOCK = threading.RLock()

# split-source: order=936 original-lines=27230-27230 hash=8a49dbb25dd35c5c
WINDOWS_JOB_SANDBOX_MARKER = "__clouds_windows_job__"

# split-source: order=937 original-lines=27231-27231 hash=e9091a7636337ff2
_WINDOWS_LOW_INTEGRITY_ROOTS: set[str] = set()

# split-source: order=938 original-lines=27232-27232 hash=e81acd4ddab152d2
_WINDOWS_LOW_INTEGRITY_FAILED_ROOTS: set[str] = set()

# split-source: order=939 original-lines=27233-27233 hash=5e5351da59b8c3e5
_WINDOWS_LOW_INTEGRITY_LOCK = threading.RLock()

# split-source: order=940 original-lines=27234-27240 hash=77416c0f2acc726f
...
# split-source: order=941 original-lines=27241-27264 hash=916341a37017a4ba
...
# split-source: order=942 original-lines=27265-27272 hash=7e07dad19e17b216
...
# split-source: order=943 original-lines=27273-27326 hash=9bc6a284727c424d
...
# split-source: order=944 original-lines=27327-27329 hash=1b60eda767ee08cf
...
# split-source: order=945 original-lines=27330-27353 hash=9037185914e9a128
...
# split-source: order=946 original-lines=27354-27391 hash=0427774e9b45bad0
...
# split-source: order=947 original-lines=27392-27399 hash=f8b21aa8be386c16
...
# split-source: order=948 original-lines=27400-27447 hash=7a33e21232b7a212
...
# split-source: order=949 original-lines=27448-27540 hash=8b61c117b2a11d8e
...
# split-source: order=950 original-lines=27541-27557 hash=a01de1a457312922
...
# split-source: order=951 original-lines=27558-27589 hash=c4a14a964d9cd5dc
...
# split-source: order=952 original-lines=27590-27643 hash=3712bcbfdf4619bd
...
# split-source: order=953 original-lines=27644-27748 hash=9dd286da7d9bf200
