...
# split-source: order=766 original-lines=8279-8296 hash=ac928f4957da521b
...
# split-source: order=1060 original-lines=29482-29490 hash=9e668c7c3fcbd2dc
...
# split-source: order=1061 original-lines=29491-29491 hash=6fd3520014763931
_IDE_SANDBOX_BACKEND_LOCK = threading.RLock()

# split-source: order=1062 original-lines=29492-29492 hash=8a49dbb25dd35c5c
WINDOWS_JOB_SANDBOX_MARKER = "__clouds_windows_job__"

# split-source: order=1063 original-lines=29493-29493 hash=e9091a7636337ff2
_WINDOWS_LOW_INTEGRITY_ROOTS: set[str] = set()

# split-source: order=1064 original-lines=29494-29494 hash=e81acd4ddab152d2
_WINDOWS_LOW_INTEGRITY_FAILED_ROOTS: set[str] = set()

# split-source: order=1065 original-lines=29495-29495 hash=5e5351da59b8c3e5
_WINDOWS_LOW_INTEGRITY_LOCK = threading.RLock()

# split-source: order=1066 original-lines=29496-29502 hash=77416c0f2acc726f
...
# split-source: order=1067 original-lines=29503-29526 hash=916341a37017a4ba
...
# split-source: order=1068 original-lines=29527-29534 hash=7e07dad19e17b216
...
# split-source: order=1069 original-lines=29535-29588 hash=9bc6a284727c424d
...
# split-source: order=1070 original-lines=29589-29591 hash=1b60eda767ee08cf
...
# split-source: order=1071 original-lines=29592-29615 hash=9037185914e9a128
...
# split-source: order=1072 original-lines=29616-29653 hash=0427774e9b45bad0
...
# split-source: order=1073 original-lines=29654-29661 hash=f8b21aa8be386c16
...
# split-source: order=1074 original-lines=29662-29709 hash=7a33e21232b7a212
...
# split-source: order=1075 original-lines=29710-29802 hash=8b61c117b2a11d8e
...
# split-source: order=1076 original-lines=29803-29819 hash=a01de1a457312922
...
# split-source: order=1077 original-lines=29820-29851 hash=c4a14a964d9cd5dc
...
# split-source: order=1078 original-lines=29852-29905 hash=3712bcbfdf4619bd
...
# split-source: order=1079 original-lines=29906-30010 hash=9dd286da7d9bf200
