...
# split-source: order=853 original-lines=21101-21109 hash=9e668c7c3fcbd2dc
...
# split-source: order=854 original-lines=21110-21110 hash=6fd3520014763931
_IDE_SANDBOX_BACKEND_LOCK = threading.RLock()

# split-source: order=855 original-lines=21111-21111 hash=8a49dbb25dd35c5c
WINDOWS_JOB_SANDBOX_MARKER = "__clouds_windows_job__"

# split-source: order=856 original-lines=21112-21112 hash=e9091a7636337ff2
_WINDOWS_LOW_INTEGRITY_ROOTS: set[str] = set()

# split-source: order=857 original-lines=21113-21113 hash=e81acd4ddab152d2
_WINDOWS_LOW_INTEGRITY_FAILED_ROOTS: set[str] = set()

# split-source: order=858 original-lines=21114-21114 hash=5e5351da59b8c3e5
_WINDOWS_LOW_INTEGRITY_LOCK = threading.RLock()

# split-source: order=859 original-lines=21115-21121 hash=77416c0f2acc726f
...
# split-source: order=860 original-lines=21122-21145 hash=916341a37017a4ba
...
# split-source: order=861 original-lines=21146-21153 hash=7e07dad19e17b216
...
# split-source: order=862 original-lines=21154-21207 hash=468af7790913e754
...
# split-source: order=863 original-lines=21208-21242 hash=2e148e5007d284ed
...
# split-source: order=864 original-lines=21243-21250 hash=f8b21aa8be386c16
...
# split-source: order=865 original-lines=21251-21298 hash=7a33e21232b7a212
...
# split-source: order=866 original-lines=21299-21391 hash=8b61c117b2a11d8e
...
# split-source: order=867 original-lines=21392-21408 hash=a01de1a457312922
...
# split-source: order=868 original-lines=21409-21440 hash=c4a14a964d9cd5dc
...
# split-source: order=869 original-lines=21441-21478 hash=276785b490e12f96
...
# split-source: order=870 original-lines=21479-21583 hash=9dd286da7d9bf200
