...
# split-source: order=761 original-lines=8148-8165 hash=ac928f4957da521b
...
# split-source: order=1039 original-lines=28575-28583 hash=9e668c7c3fcbd2dc
...
# split-source: order=1040 original-lines=28584-28584 hash=6fd3520014763931
_IDE_SANDBOX_BACKEND_LOCK = threading.RLock()

# split-source: order=1041 original-lines=28585-28585 hash=8a49dbb25dd35c5c
WINDOWS_JOB_SANDBOX_MARKER = "__clouds_windows_job__"

# split-source: order=1042 original-lines=28586-28586 hash=e9091a7636337ff2
_WINDOWS_LOW_INTEGRITY_ROOTS: set[str] = set()

# split-source: order=1043 original-lines=28587-28587 hash=e81acd4ddab152d2
_WINDOWS_LOW_INTEGRITY_FAILED_ROOTS: set[str] = set()

# split-source: order=1044 original-lines=28588-28588 hash=5e5351da59b8c3e5
_WINDOWS_LOW_INTEGRITY_LOCK = threading.RLock()

# split-source: order=1045 original-lines=28589-28595 hash=77416c0f2acc726f
...
# split-source: order=1046 original-lines=28596-28619 hash=916341a37017a4ba
...
# split-source: order=1047 original-lines=28620-28627 hash=7e07dad19e17b216
...
# split-source: order=1048 original-lines=28628-28681 hash=9bc6a284727c424d
...
# split-source: order=1049 original-lines=28682-28684 hash=1b60eda767ee08cf
...
# split-source: order=1050 original-lines=28685-28708 hash=9037185914e9a128
...
# split-source: order=1051 original-lines=28709-28746 hash=0427774e9b45bad0
...
# split-source: order=1052 original-lines=28747-28754 hash=f8b21aa8be386c16
...
# split-source: order=1053 original-lines=28755-28802 hash=7a33e21232b7a212
...
# split-source: order=1054 original-lines=28803-28895 hash=8b61c117b2a11d8e
...
# split-source: order=1055 original-lines=28896-28912 hash=a01de1a457312922
...
# split-source: order=1056 original-lines=28913-28944 hash=c4a14a964d9cd5dc
...
# split-source: order=1057 original-lines=28945-28998 hash=3712bcbfdf4619bd
...
# split-source: order=1058 original-lines=28999-29103 hash=9dd286da7d9bf200
