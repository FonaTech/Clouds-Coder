...
# split-source: order=763 original-lines=8186-8203 hash=ac928f4957da521b
...
# split-source: order=1041 original-lines=28614-28622 hash=9e668c7c3fcbd2dc
...
# split-source: order=1042 original-lines=28623-28623 hash=6fd3520014763931
_IDE_SANDBOX_BACKEND_LOCK = threading.RLock()

# split-source: order=1043 original-lines=28624-28624 hash=8a49dbb25dd35c5c
WINDOWS_JOB_SANDBOX_MARKER = "__clouds_windows_job__"

# split-source: order=1044 original-lines=28625-28625 hash=e9091a7636337ff2
_WINDOWS_LOW_INTEGRITY_ROOTS: set[str] = set()

# split-source: order=1045 original-lines=28626-28626 hash=e81acd4ddab152d2
_WINDOWS_LOW_INTEGRITY_FAILED_ROOTS: set[str] = set()

# split-source: order=1046 original-lines=28627-28627 hash=5e5351da59b8c3e5
_WINDOWS_LOW_INTEGRITY_LOCK = threading.RLock()

# split-source: order=1047 original-lines=28628-28634 hash=77416c0f2acc726f
...
# split-source: order=1048 original-lines=28635-28658 hash=916341a37017a4ba
...
# split-source: order=1049 original-lines=28659-28666 hash=7e07dad19e17b216
...
# split-source: order=1050 original-lines=28667-28720 hash=9bc6a284727c424d
...
# split-source: order=1051 original-lines=28721-28723 hash=1b60eda767ee08cf
...
# split-source: order=1052 original-lines=28724-28747 hash=9037185914e9a128
...
# split-source: order=1053 original-lines=28748-28785 hash=0427774e9b45bad0
...
# split-source: order=1054 original-lines=28786-28793 hash=f8b21aa8be386c16
...
# split-source: order=1055 original-lines=28794-28841 hash=7a33e21232b7a212
...
# split-source: order=1056 original-lines=28842-28934 hash=8b61c117b2a11d8e
...
# split-source: order=1057 original-lines=28935-28951 hash=a01de1a457312922
...
# split-source: order=1058 original-lines=28952-28983 hash=c4a14a964d9cd5dc
...
# split-source: order=1059 original-lines=28984-29037 hash=3712bcbfdf4619bd
...
# split-source: order=1060 original-lines=29038-29142 hash=9dd286da7d9bf200
