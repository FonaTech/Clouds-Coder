...
# split-source: order=934 original-lines=27244-27252 hash=9e668c7c3fcbd2dc
...
# split-source: order=935 original-lines=27253-27253 hash=6fd3520014763931
_IDE_SANDBOX_BACKEND_LOCK = threading.RLock()

# split-source: order=936 original-lines=27254-27254 hash=8a49dbb25dd35c5c
WINDOWS_JOB_SANDBOX_MARKER = "__clouds_windows_job__"

# split-source: order=937 original-lines=27255-27255 hash=e9091a7636337ff2
_WINDOWS_LOW_INTEGRITY_ROOTS: set[str] = set()

# split-source: order=938 original-lines=27256-27256 hash=e81acd4ddab152d2
_WINDOWS_LOW_INTEGRITY_FAILED_ROOTS: set[str] = set()

# split-source: order=939 original-lines=27257-27257 hash=5e5351da59b8c3e5
_WINDOWS_LOW_INTEGRITY_LOCK = threading.RLock()

# split-source: order=940 original-lines=27258-27264 hash=77416c0f2acc726f
...
# split-source: order=941 original-lines=27265-27288 hash=916341a37017a4ba
...
# split-source: order=942 original-lines=27289-27296 hash=7e07dad19e17b216
...
# split-source: order=943 original-lines=27297-27350 hash=9bc6a284727c424d
...
# split-source: order=944 original-lines=27351-27353 hash=1b60eda767ee08cf
...
# split-source: order=945 original-lines=27354-27377 hash=9037185914e9a128
...
# split-source: order=946 original-lines=27378-27415 hash=0427774e9b45bad0
...
# split-source: order=947 original-lines=27416-27423 hash=f8b21aa8be386c16
...
# split-source: order=948 original-lines=27424-27471 hash=7a33e21232b7a212
...
# split-source: order=949 original-lines=27472-27564 hash=8b61c117b2a11d8e
...
# split-source: order=950 original-lines=27565-27581 hash=a01de1a457312922
...
# split-source: order=951 original-lines=27582-27613 hash=c4a14a964d9cd5dc
...
# split-source: order=952 original-lines=27614-27667 hash=3712bcbfdf4619bd
...
# split-source: order=953 original-lines=27668-27772 hash=9dd286da7d9bf200
