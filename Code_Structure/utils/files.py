...
# split-source: order=684 original-lines=6222-6237 hash=cf719689c29b9fe5
...
# split-source: order=685 original-lines=6238-6269 hash=3a5d75d402cda3c1
...
# split-source: order=686 original-lines=6270-6302 hash=b8a72269c55092be
...
# split-source: order=778 original-lines=8365-8375 hash=697972e605b9b600
...
# split-source: order=779 original-lines=8376-8384 hash=316ad17289f49e36
...
# split-source: order=780 original-lines=8385-8387 hash=c93f45cca8221fcf

def _sha256_bytes(raw: bytes) -> str:
    return hashlib.sha256(raw).hexdigest()

# split-source: order=781 original-lines=8388-8397 hash=36451639056075f8
...
# split-source: order=782 original-lines=8398-8407 hash=54b483b1e7e9d8f0
...
# split-source: order=783 original-lines=8408-8410 hash=faccd60e74e6e648

def offline_js_lib_root(workdir: Path = WORKDIR) -> Path:
    return (workdir / "js_lib").resolve()

# split-source: order=784 original-lines=8411-8416 hash=ffde0fbf35697ed4
...
# split-source: order=785 original-lines=8417-8427 hash=17ffddf48af112d8
...
# split-source: order=786 original-lines=8428-8444 hash=173a419966e6f8f3
...
# split-source: order=787 original-lines=8445-8486 hash=9d68a11646625063
...
# split-source: order=788 original-lines=8487-8494 hash=a50266eec0068e7a
...
# split-source: order=789 original-lines=8495-8511 hash=1b9c8268492b026e
...
# split-source: order=790 original-lines=8512-8534 hash=6e59ff6950865a94
...
# split-source: order=791 original-lines=8535-8571 hash=5f7a27ed100a7a2d
...
# split-source: order=792 original-lines=8572-8616 hash=4ab36bf5ad701f8e
...
# split-source: order=793 original-lines=8617-8634 hash=d4f4dd20d3769b41
...
# split-source: order=795 original-lines=8646-8804 hash=78b50a563c075547
...
# split-source: order=796 original-lines=8805-8825 hash=e4aca336847a1b38
...
# split-source: order=797 original-lines=8826-8883 hash=8ddd983ccf227371
...
# split-source: order=798 original-lines=8884-8889 hash=552bb8592df027b7
...
# split-source: order=799 original-lines=8890-8893 hash=aa68cf01c617a357

def is_external_js_src(url: str) -> bool:
    low = str(url or "").strip().lower()
    return low.startswith("http://") or low.startswith("https://") or low.startswith("//")

# split-source: order=800 original-lines=8894-8911 hash=7a832f0a00d387ec
...
# split-source: order=801 original-lines=8912-8947 hash=f6b98368b8c7d7e3
...
# split-source: order=908 original-lines=14005-14014 hash=2201010e78ad76eb
