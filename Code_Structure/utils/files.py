...
# split-source: order=682 original-lines=6184-6199 hash=cf719689c29b9fe5
...
# split-source: order=683 original-lines=6200-6231 hash=3a5d75d402cda3c1
...
# split-source: order=684 original-lines=6232-6264 hash=b8a72269c55092be
...
# split-source: order=776 original-lines=8327-8337 hash=697972e605b9b600
...
# split-source: order=777 original-lines=8338-8346 hash=316ad17289f49e36
...
# split-source: order=778 original-lines=8347-8349 hash=c93f45cca8221fcf

def _sha256_bytes(raw: bytes) -> str:
    return hashlib.sha256(raw).hexdigest()

# split-source: order=779 original-lines=8350-8359 hash=36451639056075f8
...
# split-source: order=780 original-lines=8360-8369 hash=54b483b1e7e9d8f0
...
# split-source: order=781 original-lines=8370-8372 hash=faccd60e74e6e648

def offline_js_lib_root(workdir: Path = WORKDIR) -> Path:
    return (workdir / "js_lib").resolve()

# split-source: order=782 original-lines=8373-8378 hash=ffde0fbf35697ed4
...
# split-source: order=783 original-lines=8379-8389 hash=17ffddf48af112d8
...
# split-source: order=784 original-lines=8390-8406 hash=173a419966e6f8f3
...
# split-source: order=785 original-lines=8407-8448 hash=9d68a11646625063
...
# split-source: order=786 original-lines=8449-8456 hash=a50266eec0068e7a
...
# split-source: order=787 original-lines=8457-8473 hash=1b9c8268492b026e
...
# split-source: order=788 original-lines=8474-8496 hash=6e59ff6950865a94
...
# split-source: order=789 original-lines=8497-8533 hash=5f7a27ed100a7a2d
...
# split-source: order=790 original-lines=8534-8578 hash=4ab36bf5ad701f8e
...
# split-source: order=791 original-lines=8579-8596 hash=d4f4dd20d3769b41
...
# split-source: order=793 original-lines=8608-8766 hash=78b50a563c075547
...
# split-source: order=794 original-lines=8767-8787 hash=e4aca336847a1b38
...
# split-source: order=795 original-lines=8788-8845 hash=8ddd983ccf227371
...
# split-source: order=796 original-lines=8846-8851 hash=552bb8592df027b7
...
# split-source: order=797 original-lines=8852-8855 hash=aa68cf01c617a357

def is_external_js_src(url: str) -> bool:
    low = str(url or "").strip().lower()
    return low.startswith("http://") or low.startswith("https://") or low.startswith("//")

# split-source: order=798 original-lines=8856-8873 hash=7a832f0a00d387ec
...
# split-source: order=799 original-lines=8874-8909 hash=f6b98368b8c7d7e3
...
# split-source: order=906 original-lines=13970-13979 hash=2201010e78ad76eb
