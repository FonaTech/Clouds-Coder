...
# split-source: order=687 original-lines=6316-6331 hash=cf719689c29b9fe5
...
# split-source: order=688 original-lines=6332-6363 hash=3a5d75d402cda3c1
...
# split-source: order=689 original-lines=6364-6396 hash=b8a72269c55092be
...
# split-source: order=781 original-lines=8459-8469 hash=697972e605b9b600
...
# split-source: order=782 original-lines=8470-8478 hash=316ad17289f49e36
...
# split-source: order=783 original-lines=8479-8481 hash=c93f45cca8221fcf

def _sha256_bytes(raw: bytes) -> str:
    return hashlib.sha256(raw).hexdigest()

# split-source: order=784 original-lines=8482-8491 hash=36451639056075f8
...
# split-source: order=785 original-lines=8492-8501 hash=54b483b1e7e9d8f0
...
# split-source: order=786 original-lines=8502-8504 hash=faccd60e74e6e648

def offline_js_lib_root(workdir: Path = WORKDIR) -> Path:
    return (workdir / "js_lib").resolve()

# split-source: order=787 original-lines=8505-8510 hash=ffde0fbf35697ed4
...
# split-source: order=788 original-lines=8511-8521 hash=17ffddf48af112d8
...
# split-source: order=789 original-lines=8522-8538 hash=173a419966e6f8f3
...
# split-source: order=790 original-lines=8539-8580 hash=9d68a11646625063
...
# split-source: order=791 original-lines=8581-8588 hash=a50266eec0068e7a
...
# split-source: order=792 original-lines=8589-8605 hash=1b9c8268492b026e
...
# split-source: order=793 original-lines=8606-8628 hash=6e59ff6950865a94
...
# split-source: order=794 original-lines=8629-8665 hash=5f7a27ed100a7a2d
...
# split-source: order=795 original-lines=8666-8710 hash=4ab36bf5ad701f8e
...
# split-source: order=796 original-lines=8711-8728 hash=d4f4dd20d3769b41
...
# split-source: order=798 original-lines=8740-8898 hash=78b50a563c075547
...
# split-source: order=799 original-lines=8899-8919 hash=e4aca336847a1b38
...
# split-source: order=800 original-lines=8920-8977 hash=8ddd983ccf227371
...
# split-source: order=801 original-lines=8978-8983 hash=552bb8592df027b7
...
# split-source: order=802 original-lines=8984-8987 hash=aa68cf01c617a357

def is_external_js_src(url: str) -> bool:
    low = str(url or "").strip().lower()
    return low.startswith("http://") or low.startswith("https://") or low.startswith("//")

# split-source: order=803 original-lines=8988-9005 hash=7a832f0a00d387ec
...
# split-source: order=804 original-lines=9006-9041 hash=f6b98368b8c7d7e3
...
# split-source: order=927 original-lines=14859-14868 hash=2201010e78ad76eb
