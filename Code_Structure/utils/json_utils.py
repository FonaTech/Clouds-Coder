...
# split-source: order=171 original-lines=4189-4189 hash=48865d9a7490efb5
JSON_FSYNC_ENABLED = str(os.getenv("AGENT_JSON_FSYNC", "true") or "true").strip().lower() not in {"0", "false", "no", "off"}

# split-source: order=770 original-lines=8306-8309 hash=e1513981a13c723f
...
# split-source: order=842 original-lines=11966-11976 hash=5307c5450c8ad587
...
# split-source: order=843 original-lines=11977-12031 hash=ba4ea688566de9b0
...
# split-source: order=844 original-lines=12032-12063 hash=7d2fb800ce2aba73
...
# split-source: order=845 original-lines=12064-12069 hash=0edae7a6e375829d
...
# split-source: order=846 original-lines=12070-12093 hash=fd22a71d21becf3d
...
# split-source: order=847 original-lines=12094-12138 hash=a020af34209979c8
...
# split-source: order=865 original-lines=12402-12408 hash=107b133e877d9d78
...
# split-source: order=866 original-lines=12409-12432 hash=0a499c26dfa8ee1a
...
# split-source: order=909 original-lines=14015-14021 hash=447a2de5bc82a133
...
# split-source: order=910 original-lines=14022-14043 hash=3bf3649f6416e766
...
# split-source: order=911 original-lines=14044-14072 hash=a8537823069e1ffa
