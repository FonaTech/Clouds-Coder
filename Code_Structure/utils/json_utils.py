...
# split-source: order=169 original-lines=4151-4151 hash=48865d9a7490efb5
JSON_FSYNC_ENABLED = str(os.getenv("AGENT_JSON_FSYNC", "true") or "true").strip().lower() not in {"0", "false", "no", "off"}

# split-source: order=768 original-lines=8268-8271 hash=e1513981a13c723f
...
# split-source: order=840 original-lines=11930-11940 hash=5307c5450c8ad587
...
# split-source: order=841 original-lines=11941-11995 hash=ba4ea688566de9b0
...
# split-source: order=842 original-lines=11996-12027 hash=7d2fb800ce2aba73
...
# split-source: order=843 original-lines=12028-12033 hash=0edae7a6e375829d
...
# split-source: order=844 original-lines=12034-12057 hash=fd22a71d21becf3d
...
# split-source: order=845 original-lines=12058-12102 hash=a020af34209979c8
...
# split-source: order=863 original-lines=12366-12372 hash=107b133e877d9d78
...
# split-source: order=864 original-lines=12373-12396 hash=0a499c26dfa8ee1a
...
# split-source: order=907 original-lines=13980-13986 hash=447a2de5bc82a133
...
# split-source: order=908 original-lines=13987-14008 hash=3bf3649f6416e766
...
# split-source: order=909 original-lines=14009-14037 hash=a8537823069e1ffa
