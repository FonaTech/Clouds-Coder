...
# split-source: order=95 original-lines=218-218 hash=30f9634a0d17f4c5
MAX_TOOL_OUTPUT = 50_000

# split-source: order=350 original-lines=733-738 hash=1a4a712f8c348716
...
# split-source: order=581 original-lines=3520-3534 hash=c783a2f33fc85d5a
...
# split-source: order=594 original-lines=3780-3782 hash=29402fd9e54054b0

def safe_utf8_bytes(text: object) -> bytes:
    return str(text).encode("utf-8", errors="backslashreplace")

# split-source: order=595 original-lines=3783-3785 hash=ae25fba610e47229

def escape_invalid_utf8_text(text: object) -> str:
    return safe_utf8_bytes(text).decode("utf-8")

# split-source: order=596 original-lines=3786-3799 hash=e085c61b8c156c29
...
# split-source: order=597 original-lines=3800-3804 hash=3ec483008170e5dd
...
# split-source: order=630 original-lines=4448-4451 hash=4c2a121eb3eb0659

def trim(text: object, limit: int = MAX_TOOL_OUTPUT) -> str:
    s = str(text)
    return s if len(s) <= limit else s[:limit] + "\n...(truncated)"

# split-source: order=631 original-lines=4452-4471 hash=9b6fb292eca543dd
...
# split-source: order=633 original-lines=4519-4533 hash=f77d7ded0a73419b
...
# split-source: order=634 original-lines=4534-4552 hash=7a0ce74d6e335344
...
# split-source: order=650 original-lines=6001-6011 hash=7e4c59544e18adca
...
# split-source: order=651 original-lines=6012-6015 hash=0365ec69adb30227


def _html_esc(text: str) -> str:
    return html.escape(str(text or ""))

# split-source: order=652 original-lines=6016-6164 hash=576b0dfcc7e44d09
...
# split-source: order=655 original-lines=6182-6191 hash=cab7131fea9148ae
...
# split-source: order=656 original-lines=6192-6230 hash=9a1ecf6be1e22a77
...
# split-source: order=657 original-lines=6231-6290 hash=4f2c54bfb1a67f12
...
# split-source: order=658 original-lines=6291-6360 hash=ab0c493573492f66
...
# split-source: order=659 original-lines=6361-6379 hash=7cdc7612bc3472e3
...
# split-source: order=660 original-lines=6380-6388 hash=5d22ec67a0ef3858
...
# split-source: order=661 original-lines=6389-6444 hash=6803b5d1cad1e866
...
# split-source: order=662 original-lines=6445-6474 hash=4f3eb17b1856f763
...
# split-source: order=747 original-lines=9925-9943 hash=b4fd9c47feae07d0
...
# split-source: order=748 original-lines=9944-9949 hash=fc6e1578f1dfb8e0
...
# split-source: order=749 original-lines=9950-9953 hash=f5d9ac4c2c90cef7


def _row_is_hot(row: dict) -> bool:
    return str((row or {}).get("kind", "")).strip().lower() in {"add", "delete"}

# split-source: order=750 original-lines=9954-9977 hash=5862d764d6ac180a
...
# split-source: order=751 original-lines=9978-10027 hash=6f30990ffc308229
...
# split-source: order=752 original-lines=10028-10162 hash=220a462e9f681355
...
# split-source: order=753 original-lines=10163-10195 hash=a8b71f66e76048d1
...
# split-source: order=754 original-lines=10196-10209 hash=effc08a63226e126
