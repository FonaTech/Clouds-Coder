...
# split-source: order=162 original-lines=4270-4270 hash=30f9634a0d17f4c5
MAX_TOOL_OUTPUT = 50_000

# split-source: order=501 original-lines=5041-5046 hash=1a4a712f8c348716
...
# split-source: order=749 original-lines=7994-8008 hash=c783a2f33fc85d5a
...
# split-source: order=762 original-lines=8254-8256 hash=29402fd9e54054b0

def safe_utf8_bytes(text: object) -> bytes:
    return str(text).encode("utf-8", errors="backslashreplace")

# split-source: order=763 original-lines=8257-8259 hash=ae25fba610e47229

def escape_invalid_utf8_text(text: object) -> str:
    return safe_utf8_bytes(text).decode("utf-8")

# split-source: order=764 original-lines=8260-8273 hash=e085c61b8c156c29
...
# split-source: order=765 original-lines=8274-8278 hash=3ec483008170e5dd
...
# split-source: order=805 original-lines=9041-9044 hash=4c2a121eb3eb0659

def trim(text: object, limit: int = MAX_TOOL_OUTPUT) -> str:
    s = str(text)
    return s if len(s) <= limit else s[:limit] + "\n...(truncated)"

# split-source: order=813 original-lines=9320-9339 hash=9b6fb292eca543dd
...
# split-source: order=815 original-lines=9392-9406 hash=f77d7ded0a73419b
...
# split-source: order=816 original-lines=9407-9425 hash=7a0ce74d6e335344
...
# split-source: order=832 original-lines=11585-11595 hash=7e4c59544e18adca
...
# split-source: order=833 original-lines=11596-11599 hash=0365ec69adb30227


def _html_esc(text: str) -> str:
    return html.escape(str(text or ""))

# split-source: order=834 original-lines=11600-11748 hash=576b0dfcc7e44d09
...
# split-source: order=837 original-lines=11766-11775 hash=cab7131fea9148ae
...
# split-source: order=838 original-lines=11776-11814 hash=9a1ecf6be1e22a77
...
# split-source: order=839 original-lines=11815-11874 hash=4f2c54bfb1a67f12
...
# split-source: order=840 original-lines=11875-11944 hash=ab0c493573492f66
...
# split-source: order=841 original-lines=11945-11963 hash=7cdc7612bc3472e3
...
# split-source: order=842 original-lines=11964-11972 hash=5d22ec67a0ef3858
...
# split-source: order=843 original-lines=11973-12028 hash=6803b5d1cad1e866
...
# split-source: order=844 original-lines=12029-12058 hash=4f3eb17b1856f763
...
# split-source: order=951 original-lines=16482-16500 hash=b4fd9c47feae07d0
...
# split-source: order=952 original-lines=16501-16506 hash=fc6e1578f1dfb8e0
...
# split-source: order=953 original-lines=16507-16510 hash=f5d9ac4c2c90cef7


def _row_is_hot(row: dict) -> bool:
    return str((row or {}).get("kind", "")).strip().lower() in {"add", "delete"}

# split-source: order=954 original-lines=16511-16534 hash=5862d764d6ac180a
...
# split-source: order=955 original-lines=16535-16584 hash=6f30990ffc308229
...
# split-source: order=956 original-lines=16585-16719 hash=220a462e9f681355
...
# split-source: order=957 original-lines=16720-16752 hash=a8b71f66e76048d1
...
# split-source: order=958 original-lines=16753-16766 hash=effc08a63226e126
