...
# split-source: order=147 original-lines=3815-3815 hash=30f9634a0d17f4c5
MAX_TOOL_OUTPUT = 50_000

# split-source: order=419 original-lines=4379-4384 hash=1a4a712f8c348716
...
# split-source: order=653 original-lines=7226-7240 hash=c783a2f33fc85d5a
...
# split-source: order=666 original-lines=7486-7488 hash=29402fd9e54054b0

def safe_utf8_bytes(text: object) -> bytes:
    return str(text).encode("utf-8", errors="backslashreplace")

# split-source: order=667 original-lines=7489-7491 hash=ae25fba610e47229

def escape_invalid_utf8_text(text: object) -> str:
    return safe_utf8_bytes(text).decode("utf-8")

# split-source: order=668 original-lines=7492-7505 hash=e085c61b8c156c29
...
# split-source: order=669 original-lines=7506-7510 hash=3ec483008170e5dd
...
# split-source: order=709 original-lines=8273-8276 hash=4c2a121eb3eb0659

def trim(text: object, limit: int = MAX_TOOL_OUTPUT) -> str:
    s = str(text)
    return s if len(s) <= limit else s[:limit] + "\n...(truncated)"

# split-source: order=710 original-lines=8277-8296 hash=9b6fb292eca543dd
...
# split-source: order=712 original-lines=8344-8358 hash=f77d7ded0a73419b
...
# split-source: order=713 original-lines=8359-8377 hash=7a0ce74d6e335344
...
# split-source: order=729 original-lines=10539-10549 hash=7e4c59544e18adca
...
# split-source: order=730 original-lines=10550-10553 hash=0365ec69adb30227


def _html_esc(text: str) -> str:
    return html.escape(str(text or ""))

# split-source: order=731 original-lines=10554-10702 hash=576b0dfcc7e44d09
...
# split-source: order=734 original-lines=10720-10729 hash=cab7131fea9148ae
...
# split-source: order=735 original-lines=10730-10768 hash=9a1ecf6be1e22a77
...
# split-source: order=736 original-lines=10769-10828 hash=4f2c54bfb1a67f12
...
# split-source: order=737 original-lines=10829-10898 hash=ab0c493573492f66
...
# split-source: order=738 original-lines=10899-10917 hash=7cdc7612bc3472e3
...
# split-source: order=739 original-lines=10918-10926 hash=5d22ec67a0ef3858
...
# split-source: order=740 original-lines=10927-10982 hash=6803b5d1cad1e866
...
# split-source: order=741 original-lines=10983-11012 hash=4f3eb17b1856f763
...
# split-source: order=826 original-lines=14536-14554 hash=b4fd9c47feae07d0
...
# split-source: order=827 original-lines=14555-14560 hash=fc6e1578f1dfb8e0
...
# split-source: order=828 original-lines=14561-14564 hash=f5d9ac4c2c90cef7


def _row_is_hot(row: dict) -> bool:
    return str((row or {}).get("kind", "")).strip().lower() in {"add", "delete"}

# split-source: order=829 original-lines=14565-14588 hash=5862d764d6ac180a
...
# split-source: order=830 original-lines=14589-14638 hash=6f30990ffc308229
...
# split-source: order=831 original-lines=14639-14773 hash=220a462e9f681355
...
# split-source: order=832 original-lines=14774-14806 hash=a8b71f66e76048d1
...
# split-source: order=833 original-lines=14807-14820 hash=effc08a63226e126
