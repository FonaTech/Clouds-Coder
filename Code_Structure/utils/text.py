...
# split-source: order=162 original-lines=4272-4272 hash=30f9634a0d17f4c5
MAX_TOOL_OUTPUT = 50_000

# split-source: order=501 original-lines=5043-5048 hash=1a4a712f8c348716
...
# split-source: order=749 original-lines=7996-8010 hash=c783a2f33fc85d5a
...
# split-source: order=762 original-lines=8256-8258 hash=29402fd9e54054b0

def safe_utf8_bytes(text: object) -> bytes:
    return str(text).encode("utf-8", errors="backslashreplace")

# split-source: order=763 original-lines=8259-8261 hash=ae25fba610e47229

def escape_invalid_utf8_text(text: object) -> str:
    return safe_utf8_bytes(text).decode("utf-8")

# split-source: order=764 original-lines=8262-8275 hash=e085c61b8c156c29
...
# split-source: order=765 original-lines=8276-8280 hash=3ec483008170e5dd
...
# split-source: order=805 original-lines=9043-9046 hash=4c2a121eb3eb0659

def trim(text: object, limit: int = MAX_TOOL_OUTPUT) -> str:
    s = str(text)
    return s if len(s) <= limit else s[:limit] + "\n...(truncated)"

# split-source: order=813 original-lines=9322-9341 hash=9b6fb292eca543dd
...
# split-source: order=815 original-lines=9394-9408 hash=f77d7ded0a73419b
...
# split-source: order=816 original-lines=9409-9427 hash=7a0ce74d6e335344
...
# split-source: order=832 original-lines=11587-11597 hash=7e4c59544e18adca
...
# split-source: order=833 original-lines=11598-11601 hash=0365ec69adb30227


def _html_esc(text: str) -> str:
    return html.escape(str(text or ""))

# split-source: order=834 original-lines=11602-11750 hash=576b0dfcc7e44d09
...
# split-source: order=837 original-lines=11768-11777 hash=cab7131fea9148ae
...
# split-source: order=838 original-lines=11778-11816 hash=9a1ecf6be1e22a77
...
# split-source: order=839 original-lines=11817-11876 hash=4f2c54bfb1a67f12
...
# split-source: order=840 original-lines=11877-11946 hash=ab0c493573492f66
...
# split-source: order=841 original-lines=11947-11965 hash=7cdc7612bc3472e3
...
# split-source: order=842 original-lines=11966-11974 hash=5d22ec67a0ef3858
...
# split-source: order=843 original-lines=11975-12030 hash=6803b5d1cad1e866
...
# split-source: order=844 original-lines=12031-12060 hash=4f3eb17b1856f763
...
# split-source: order=951 original-lines=16484-16502 hash=b4fd9c47feae07d0
...
# split-source: order=952 original-lines=16503-16508 hash=fc6e1578f1dfb8e0
...
# split-source: order=953 original-lines=16509-16512 hash=f5d9ac4c2c90cef7


def _row_is_hot(row: dict) -> bool:
    return str((row or {}).get("kind", "")).strip().lower() in {"add", "delete"}

# split-source: order=954 original-lines=16513-16536 hash=5862d764d6ac180a
...
# split-source: order=955 original-lines=16537-16586 hash=6f30990ffc308229
...
# split-source: order=956 original-lines=16587-16721 hash=220a462e9f681355
...
# split-source: order=957 original-lines=16722-16754 hash=a8b71f66e76048d1
...
# split-source: order=958 original-lines=16755-16768 hash=effc08a63226e126
