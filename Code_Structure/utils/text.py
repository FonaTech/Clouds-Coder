...
# split-source: order=159 original-lines=4177-4177 hash=30f9634a0d17f4c5
MAX_TOOL_OUTPUT = 50_000

# split-source: order=498 original-lines=4948-4953 hash=1a4a712f8c348716
...
# split-source: order=746 original-lines=7901-7915 hash=c783a2f33fc85d5a
...
# split-source: order=759 original-lines=8161-8163 hash=29402fd9e54054b0

def safe_utf8_bytes(text: object) -> bytes:
    return str(text).encode("utf-8", errors="backslashreplace")

# split-source: order=760 original-lines=8164-8166 hash=ae25fba610e47229

def escape_invalid_utf8_text(text: object) -> str:
    return safe_utf8_bytes(text).decode("utf-8")

# split-source: order=761 original-lines=8167-8180 hash=e085c61b8c156c29
...
# split-source: order=762 original-lines=8181-8185 hash=3ec483008170e5dd
...
# split-source: order=802 original-lines=8948-8951 hash=4c2a121eb3eb0659

def trim(text: object, limit: int = MAX_TOOL_OUTPUT) -> str:
    s = str(text)
    return s if len(s) <= limit else s[:limit] + "\n...(truncated)"

# split-source: order=810 original-lines=9227-9246 hash=9b6fb292eca543dd
...
# split-source: order=812 original-lines=9299-9313 hash=f77d7ded0a73419b
...
# split-source: order=813 original-lines=9314-9332 hash=7a0ce74d6e335344
...
# split-source: order=829 original-lines=11492-11502 hash=7e4c59544e18adca
...
# split-source: order=830 original-lines=11503-11506 hash=0365ec69adb30227


def _html_esc(text: str) -> str:
    return html.escape(str(text or ""))

# split-source: order=831 original-lines=11507-11655 hash=576b0dfcc7e44d09
...
# split-source: order=834 original-lines=11673-11682 hash=cab7131fea9148ae
...
# split-source: order=835 original-lines=11683-11721 hash=9a1ecf6be1e22a77
...
# split-source: order=836 original-lines=11722-11781 hash=4f2c54bfb1a67f12
...
# split-source: order=837 original-lines=11782-11851 hash=ab0c493573492f66
...
# split-source: order=838 original-lines=11852-11870 hash=7cdc7612bc3472e3
...
# split-source: order=839 original-lines=11871-11879 hash=5d22ec67a0ef3858
...
# split-source: order=840 original-lines=11880-11935 hash=6803b5d1cad1e866
...
# split-source: order=841 original-lines=11936-11965 hash=4f3eb17b1856f763
...
# split-source: order=932 original-lines=15629-15647 hash=b4fd9c47feae07d0
...
# split-source: order=933 original-lines=15648-15653 hash=fc6e1578f1dfb8e0
...
# split-source: order=934 original-lines=15654-15657 hash=f5d9ac4c2c90cef7


def _row_is_hot(row: dict) -> bool:
    return str((row or {}).get("kind", "")).strip().lower() in {"add", "delete"}

# split-source: order=935 original-lines=15658-15681 hash=5862d764d6ac180a
...
# split-source: order=936 original-lines=15682-15731 hash=6f30990ffc308229
...
# split-source: order=937 original-lines=15732-15866 hash=220a462e9f681355
...
# split-source: order=938 original-lines=15867-15899 hash=a8b71f66e76048d1
...
# split-source: order=939 original-lines=15900-15913 hash=effc08a63226e126
