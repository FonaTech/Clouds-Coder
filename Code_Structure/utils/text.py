...
# split-source: order=162 original-lines=4271-4271 hash=30f9634a0d17f4c5
MAX_TOOL_OUTPUT = 50_000

# split-source: order=501 original-lines=5042-5047 hash=1a4a712f8c348716
...
# split-source: order=749 original-lines=7995-8009 hash=c783a2f33fc85d5a
...
# split-source: order=762 original-lines=8255-8257 hash=29402fd9e54054b0

def safe_utf8_bytes(text: object) -> bytes:
    return str(text).encode("utf-8", errors="backslashreplace")

# split-source: order=763 original-lines=8258-8260 hash=ae25fba610e47229

def escape_invalid_utf8_text(text: object) -> str:
    return safe_utf8_bytes(text).decode("utf-8")

# split-source: order=764 original-lines=8261-8274 hash=e085c61b8c156c29
...
# split-source: order=765 original-lines=8275-8279 hash=3ec483008170e5dd
...
# split-source: order=805 original-lines=9042-9045 hash=4c2a121eb3eb0659

def trim(text: object, limit: int = MAX_TOOL_OUTPUT) -> str:
    s = str(text)
    return s if len(s) <= limit else s[:limit] + "\n...(truncated)"

# split-source: order=813 original-lines=9321-9340 hash=9b6fb292eca543dd
...
# split-source: order=815 original-lines=9393-9407 hash=f77d7ded0a73419b
...
# split-source: order=816 original-lines=9408-9426 hash=7a0ce74d6e335344
...
# split-source: order=832 original-lines=11586-11596 hash=7e4c59544e18adca
...
# split-source: order=833 original-lines=11597-11600 hash=0365ec69adb30227


def _html_esc(text: str) -> str:
    return html.escape(str(text or ""))

# split-source: order=834 original-lines=11601-11749 hash=576b0dfcc7e44d09
...
# split-source: order=837 original-lines=11767-11776 hash=cab7131fea9148ae
...
# split-source: order=838 original-lines=11777-11815 hash=9a1ecf6be1e22a77
...
# split-source: order=839 original-lines=11816-11875 hash=4f2c54bfb1a67f12
...
# split-source: order=840 original-lines=11876-11945 hash=ab0c493573492f66
...
# split-source: order=841 original-lines=11946-11964 hash=7cdc7612bc3472e3
...
# split-source: order=842 original-lines=11965-11973 hash=5d22ec67a0ef3858
...
# split-source: order=843 original-lines=11974-12029 hash=6803b5d1cad1e866
...
# split-source: order=844 original-lines=12030-12059 hash=4f3eb17b1856f763
...
# split-source: order=951 original-lines=16483-16501 hash=b4fd9c47feae07d0
...
# split-source: order=952 original-lines=16502-16507 hash=fc6e1578f1dfb8e0
...
# split-source: order=953 original-lines=16508-16511 hash=f5d9ac4c2c90cef7


def _row_is_hot(row: dict) -> bool:
    return str((row or {}).get("kind", "")).strip().lower() in {"add", "delete"}

# split-source: order=954 original-lines=16512-16535 hash=5862d764d6ac180a
...
# split-source: order=955 original-lines=16536-16585 hash=6f30990ffc308229
...
# split-source: order=956 original-lines=16586-16720 hash=220a462e9f681355
...
# split-source: order=957 original-lines=16721-16753 hash=a8b71f66e76048d1
...
# split-source: order=958 original-lines=16754-16767 hash=effc08a63226e126
