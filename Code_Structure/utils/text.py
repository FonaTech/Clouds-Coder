...
# split-source: order=653 original-lines=7248-7262 hash=c783a2f33fc85d5a
...
# split-source: order=666 original-lines=7508-7510 hash=29402fd9e54054b0

def safe_utf8_bytes(text: object) -> bytes:
    return str(text).encode("utf-8", errors="backslashreplace")

# split-source: order=667 original-lines=7511-7513 hash=ae25fba610e47229

def escape_invalid_utf8_text(text: object) -> str:
    return safe_utf8_bytes(text).decode("utf-8")

# split-source: order=668 original-lines=7514-7527 hash=e085c61b8c156c29
...
# split-source: order=669 original-lines=7528-7532 hash=3ec483008170e5dd
...
# split-source: order=709 original-lines=8295-8298 hash=4c2a121eb3eb0659

def trim(text: object, limit: int = MAX_TOOL_OUTPUT) -> str:
    s = str(text)
    return s if len(s) <= limit else s[:limit] + "\n...(truncated)"

# split-source: order=710 original-lines=8299-8318 hash=9b6fb292eca543dd
...
# split-source: order=712 original-lines=8366-8380 hash=f77d7ded0a73419b
...
# split-source: order=713 original-lines=8381-8399 hash=7a0ce74d6e335344
...
# split-source: order=729 original-lines=10561-10571 hash=7e4c59544e18adca
...
# split-source: order=730 original-lines=10572-10575 hash=0365ec69adb30227


def _html_esc(text: str) -> str:
    return html.escape(str(text or ""))

# split-source: order=731 original-lines=10576-10724 hash=576b0dfcc7e44d09
...
# split-source: order=734 original-lines=10742-10751 hash=cab7131fea9148ae
...
# split-source: order=735 original-lines=10752-10790 hash=9a1ecf6be1e22a77
...
# split-source: order=736 original-lines=10791-10850 hash=4f2c54bfb1a67f12
...
# split-source: order=737 original-lines=10851-10920 hash=ab0c493573492f66
...
# split-source: order=738 original-lines=10921-10939 hash=7cdc7612bc3472e3
...
# split-source: order=739 original-lines=10940-10948 hash=5d22ec67a0ef3858
...
# split-source: order=740 original-lines=10949-11004 hash=6803b5d1cad1e866
...
# split-source: order=741 original-lines=11005-11034 hash=4f3eb17b1856f763
