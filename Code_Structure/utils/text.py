...
# split-source: order=157 original-lines=4139-4139 hash=30f9634a0d17f4c5
MAX_TOOL_OUTPUT = 50_000

# split-source: order=496 original-lines=4910-4915 hash=1a4a712f8c348716
...
# split-source: order=744 original-lines=7863-7877 hash=c783a2f33fc85d5a
...
# split-source: order=757 original-lines=8123-8125 hash=29402fd9e54054b0

def safe_utf8_bytes(text: object) -> bytes:
    return str(text).encode("utf-8", errors="backslashreplace")

# split-source: order=758 original-lines=8126-8128 hash=ae25fba610e47229

def escape_invalid_utf8_text(text: object) -> str:
    return safe_utf8_bytes(text).decode("utf-8")

# split-source: order=759 original-lines=8129-8142 hash=e085c61b8c156c29
...
# split-source: order=760 original-lines=8143-8147 hash=3ec483008170e5dd
...
# split-source: order=800 original-lines=8910-8913 hash=4c2a121eb3eb0659

def trim(text: object, limit: int = MAX_TOOL_OUTPUT) -> str:
    s = str(text)
    return s if len(s) <= limit else s[:limit] + "\n...(truncated)"

# split-source: order=808 original-lines=9189-9208 hash=9b6fb292eca543dd
...
# split-source: order=810 original-lines=9261-9275 hash=f77d7ded0a73419b
...
# split-source: order=811 original-lines=9276-9294 hash=7a0ce74d6e335344
...
# split-source: order=827 original-lines=11456-11466 hash=7e4c59544e18adca
...
# split-source: order=828 original-lines=11467-11470 hash=0365ec69adb30227


def _html_esc(text: str) -> str:
    return html.escape(str(text or ""))

# split-source: order=829 original-lines=11471-11619 hash=576b0dfcc7e44d09
...
# split-source: order=832 original-lines=11637-11646 hash=cab7131fea9148ae
...
# split-source: order=833 original-lines=11647-11685 hash=9a1ecf6be1e22a77
...
# split-source: order=834 original-lines=11686-11745 hash=4f2c54bfb1a67f12
...
# split-source: order=835 original-lines=11746-11815 hash=ab0c493573492f66
...
# split-source: order=836 original-lines=11816-11834 hash=7cdc7612bc3472e3
...
# split-source: order=837 original-lines=11835-11843 hash=5d22ec67a0ef3858
...
# split-source: order=838 original-lines=11844-11899 hash=6803b5d1cad1e866
...
# split-source: order=839 original-lines=11900-11929 hash=4f3eb17b1856f763
...
# split-source: order=930 original-lines=15590-15608 hash=b4fd9c47feae07d0
...
# split-source: order=931 original-lines=15609-15614 hash=fc6e1578f1dfb8e0
...
# split-source: order=932 original-lines=15615-15618 hash=f5d9ac4c2c90cef7


def _row_is_hot(row: dict) -> bool:
    return str((row or {}).get("kind", "")).strip().lower() in {"add", "delete"}

# split-source: order=933 original-lines=15619-15642 hash=5862d764d6ac180a
...
# split-source: order=934 original-lines=15643-15692 hash=6f30990ffc308229
...
# split-source: order=935 original-lines=15693-15827 hash=220a462e9f681355
...
# split-source: order=936 original-lines=15828-15860 hash=a8b71f66e76048d1
...
# split-source: order=937 original-lines=15861-15874 hash=effc08a63226e126
