...
# split-source: order=122 original-lines=3912-3912 hash=34fee98dbda2c56a
_URL_OPEN_ORIGINAL = urlopen

# split-source: order=123 original-lines=3913-3913 hash=d0b8577f025ef0b5
_HTTP_SSL_CONTEXT = None

# split-source: order=150 original-lines=3977-4000 hash=7a1e316af503fc49
...
# split-source: order=151 original-lines=4001-4010 hash=4d63800588472a20
...
# split-source: order=774 original-lines=8403-8405 hash=45f4d1c3ae2bda86

def json_response_bytes(obj: object) -> bytes:
    return safe_utf8_bytes(json_dumps(obj))

# split-source: order=775 original-lines=8406-8419 hash=b8e0fcf45e3a740c
...
# split-source: order=776 original-lines=8420-8433 hash=d097208eea9ea225
