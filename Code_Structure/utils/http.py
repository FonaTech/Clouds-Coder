...
# split-source: order=119 original-lines=3819-3819 hash=34fee98dbda2c56a
_URL_OPEN_ORIGINAL = urlopen

# split-source: order=120 original-lines=3820-3820 hash=d0b8577f025ef0b5
_HTTP_SSL_CONTEXT = None

# split-source: order=147 original-lines=3884-3907 hash=7a1e316af503fc49
...
# split-source: order=148 original-lines=3908-3917 hash=4d63800588472a20
...
# split-source: order=771 original-lines=8310-8312 hash=45f4d1c3ae2bda86

def json_response_bytes(obj: object) -> bytes:
    return safe_utf8_bytes(json_dumps(obj))

# split-source: order=772 original-lines=8313-8326 hash=b8e0fcf45e3a740c
...
# split-source: order=773 original-lines=8327-8340 hash=d097208eea9ea225
