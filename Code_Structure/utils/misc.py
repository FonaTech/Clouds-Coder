...
# split-source: order=746 original-lines=7987-7989 hash=745dbe7e9c6ea772

def now_ts() -> float:
    return time.time()

# split-source: order=747 original-lines=7990-7992 hash=a8196f2cb960defc


_benign_socket_log_lock = threading.Lock()

# split-source: order=748 original-lines=7993-7993 hash=aae2eb4df5cce110
_benign_socket_log_state: dict[str, dict[str, float | int]] = {}

# split-source: order=750 original-lines=8009-8029 hash=90391ee449871b43
...
# split-source: order=751 original-lines=8030-8041 hash=172cf9bd7c8ecaf5
...
# split-source: order=752 original-lines=8042-8078 hash=67186d8b6ed904ee
...
# split-source: order=753 original-lines=8079-8085 hash=d0ad563a0b5da477
...
# split-source: order=754 original-lines=8086-8101 hash=1ca16ae8018ba100
...
# split-source: order=755 original-lines=8102-8113 hash=4e362612a8706766
...
# split-source: order=756 original-lines=8114-8115 hash=e4278afeb56c9b4f

_LOCAL_LAN_IP_CACHE: dict[str, object] = {"ts": 0.0, "ip": ""}

# split-source: order=757 original-lines=8116-8129 hash=ecee909e6f5285b0
...
# split-source: order=777 original-lines=8434-8436 hash=dfed892a107f1c65

def make_id(prefix: str) -> str:
    return f"{prefix}_{uuid.uuid4().hex[:8]}"

# split-source: order=778 original-lines=8437-8440 hash=67513f5713af9d3f

def sanitize_profile_id(raw: str) -> str:
    pid = re.sub(r"[^A-Za-z0-9._-]+", "-", (raw or "").strip().lower()).strip("-")
    return pid or "profile"

# split-source: order=922 original-lines=14420-14427 hash=794844d6c7fe3db4
...
# split-source: order=926 original-lines=14844-14857 hash=80f1c7a9452235b7
...
# split-source: order=985 original-lines=17720-17725 hash=f5ed28063e7e4a7a
