...
# split-source: order=578 original-lines=3512-3514 hash=745dbe7e9c6ea772

def now_ts() -> float:
    return time.time()

# split-source: order=579 original-lines=3515-3517 hash=a8196f2cb960defc


_benign_socket_log_lock = threading.Lock()

# split-source: order=580 original-lines=3518-3518 hash=aae2eb4df5cce110
_benign_socket_log_state: dict[str, dict[str, float | int]] = {}

# split-source: order=582 original-lines=3534-3554 hash=90391ee449871b43
...
# split-source: order=583 original-lines=3555-3566 hash=172cf9bd7c8ecaf5
...
# split-source: order=584 original-lines=3567-3603 hash=67186d8b6ed904ee
...
# split-source: order=585 original-lines=3604-3610 hash=d0ad563a0b5da477
...
# split-source: order=586 original-lines=3611-3626 hash=1ca16ae8018ba100
...
# split-source: order=587 original-lines=3627-3638 hash=4e362612a8706766
...
# split-source: order=588 original-lines=3639-3640 hash=e4278afeb56c9b4f

_LOCAL_LAN_IP_CACHE: dict[str, object] = {"ts": 0.0, "ip": ""}

# split-source: order=589 original-lines=3641-3654 hash=ecee909e6f5285b0
...
# split-source: order=602 original-lines=3839-3841 hash=dfed892a107f1c65

def make_id(prefix: str) -> str:
    return f"{prefix}_{uuid.uuid4().hex[:8]}"

# split-source: order=603 original-lines=3842-3845 hash=67513f5713af9d3f

def sanitize_profile_id(raw: str) -> str:
    pid = re.sub(r"[^A-Za-z0-9._-]+", "-", (raw or "").strip().lower()).strip("-")
    return pid or "profile"

# split-source: order=724 original-lines=8076-8083 hash=794844d6c7fe3db4
...
# split-source: order=728 original-lines=8425-8438 hash=80f1c7a9452235b7
