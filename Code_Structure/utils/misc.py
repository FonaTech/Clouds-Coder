...
# split-source: order=743 original-lines=7894-7896 hash=745dbe7e9c6ea772

def now_ts() -> float:
    return time.time()

# split-source: order=744 original-lines=7897-7899 hash=a8196f2cb960defc


_benign_socket_log_lock = threading.Lock()

# split-source: order=745 original-lines=7900-7900 hash=aae2eb4df5cce110
_benign_socket_log_state: dict[str, dict[str, float | int]] = {}

# split-source: order=747 original-lines=7916-7936 hash=90391ee449871b43
...
# split-source: order=748 original-lines=7937-7948 hash=172cf9bd7c8ecaf5
...
# split-source: order=749 original-lines=7949-7985 hash=67186d8b6ed904ee
...
# split-source: order=750 original-lines=7986-7992 hash=d0ad563a0b5da477
...
# split-source: order=751 original-lines=7993-8008 hash=1ca16ae8018ba100
...
# split-source: order=752 original-lines=8009-8020 hash=4e362612a8706766
...
# split-source: order=753 original-lines=8021-8022 hash=e4278afeb56c9b4f

_LOCAL_LAN_IP_CACHE: dict[str, object] = {"ts": 0.0, "ip": ""}

# split-source: order=754 original-lines=8023-8036 hash=ecee909e6f5285b0
...
# split-source: order=774 original-lines=8341-8343 hash=dfed892a107f1c65

def make_id(prefix: str) -> str:
    return f"{prefix}_{uuid.uuid4().hex[:8]}"

# split-source: order=775 original-lines=8344-8347 hash=67513f5713af9d3f

def sanitize_profile_id(raw: str) -> str:
    pid = re.sub(r"[^A-Za-z0-9._-]+", "-", (raw or "").strip().lower()).strip("-")
    return pid or "profile"

# split-source: order=903 original-lines=13567-13574 hash=794844d6c7fe3db4
...
# split-source: order=907 original-lines=13991-14004 hash=80f1c7a9452235b7
...
# split-source: order=966 original-lines=16867-16872 hash=f5ed28063e7e4a7a
