...
# split-source: order=741 original-lines=7856-7858 hash=745dbe7e9c6ea772

def now_ts() -> float:
    return time.time()

# split-source: order=742 original-lines=7859-7861 hash=a8196f2cb960defc


_benign_socket_log_lock = threading.Lock()

# split-source: order=743 original-lines=7862-7862 hash=aae2eb4df5cce110
_benign_socket_log_state: dict[str, dict[str, float | int]] = {}

# split-source: order=745 original-lines=7878-7898 hash=90391ee449871b43
...
# split-source: order=746 original-lines=7899-7910 hash=172cf9bd7c8ecaf5
...
# split-source: order=747 original-lines=7911-7947 hash=67186d8b6ed904ee
...
# split-source: order=748 original-lines=7948-7954 hash=d0ad563a0b5da477
...
# split-source: order=749 original-lines=7955-7970 hash=1ca16ae8018ba100
...
# split-source: order=750 original-lines=7971-7982 hash=4e362612a8706766
...
# split-source: order=751 original-lines=7983-7984 hash=e4278afeb56c9b4f

_LOCAL_LAN_IP_CACHE: dict[str, object] = {"ts": 0.0, "ip": ""}

# split-source: order=752 original-lines=7985-7998 hash=ecee909e6f5285b0
...
# split-source: order=772 original-lines=8303-8305 hash=dfed892a107f1c65

def make_id(prefix: str) -> str:
    return f"{prefix}_{uuid.uuid4().hex[:8]}"

# split-source: order=773 original-lines=8306-8309 hash=67513f5713af9d3f

def sanitize_profile_id(raw: str) -> str:
    pid = re.sub(r"[^A-Za-z0-9._-]+", "-", (raw or "").strip().lower()).strip("-")
    return pid or "profile"

# split-source: order=901 original-lines=13532-13539 hash=794844d6c7fe3db4
...
# split-source: order=905 original-lines=13956-13969 hash=80f1c7a9452235b7
...
# split-source: order=964 original-lines=16828-16833 hash=f5ed28063e7e4a7a
