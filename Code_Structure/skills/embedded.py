...
# split-source: order=961 original-lines=16771-16772 hash=abb626cdb913089f
...
# split-source: order=962 original-lines=16773-16773 hash=56a4b6adc5fad38d
EMBEDDED_SKILLS_ARCHIVE_SHA256 = "293f055c6dee75eaea584a139718cf97eae9d5d23ce0a62523cf30ace18af06a"

# split-source: order=963 original-lines=16774-16796 hash=7c652447a2f9b6a4
...
# split-source: order=988 original-lines=20032-20034 hash=a7b0ed5bb372a098


BUILTIN_CLAWHUB_SKILLS_VERSION = "2026-03-01.1"

# split-source: order=989 original-lines=20035-20280 hash=01d2a892241f2adc
...
# split-source: order=991 original-lines=20328-20502 hash=a81a11e23c0dbc72
...
# split-source: order=994 original-lines=20534-20535 hash=976d6d82b3c5284d

SKILL_PROTOCOL_LOCAL = "local.skill.md.v1"

# split-source: order=995 original-lines=20536-20536 hash=a07964758270f21c
SKILL_PROTOCOL_CLAWHUB = "clawhub.skill.v1"

# split-source: order=996 original-lines=20537-20537 hash=253cfef47b93d620
SKILL_PROTOCOL_HTTP_JSON = "http.skill.json.v1"

# split-source: order=997 original-lines=20538-20570 hash=3e2a5b0d21d4ed85
