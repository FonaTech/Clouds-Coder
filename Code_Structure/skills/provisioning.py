...
# split-source: order=983 original-lines=17650-17715 hash=893a5c7fc3fc79dc
...
# split-source: order=984 original-lines=17716-17719 hash=488e35a795d9caca
...
# split-source: order=986 original-lines=17726-17742 hash=5f75bbd1af19cd42
...
# split-source: order=987 original-lines=17743-17758 hash=1b6b77e50dc74a25
...
# split-source: order=988 original-lines=17759-17765 hash=9d5e4bda227c4064
...
# split-source: order=989 original-lines=17766-17855 hash=38b2da828440d41b
...
# split-source: order=990 original-lines=17856-17956 hash=7f3c2b04dcae2810
...
# split-source: order=991 original-lines=17957-17977 hash=0292dde0352a724f
...
# split-source: order=992 original-lines=17978-18033 hash=da1db978dee59a36
...
# split-source: order=993 original-lines=18034-18037 hash=380c4fa76ed211cc

def _sanitize_skill_slug(raw: str, fallback: str = "skills-gen") -> str:
    slug = re.sub(r"[^A-Za-z0-9._-]+", "-", str(raw or "").strip()).strip("-")
    return slug or fallback

# split-source: order=994 original-lines=18038-18070 hash=812fe6d2a2b42325
...
# split-source: order=995 original-lines=18071-18076 hash=577a94a4aa1e7aad
...
# split-source: order=996 original-lines=18077-18161 hash=e656c95087b6c2aa
...
# split-source: order=997 original-lines=18162-18435 hash=0a52d4a1b3b5c3a3
...
# split-source: order=998 original-lines=18436-18555 hash=7da06e07ba1dd983
...
# split-source: order=999 original-lines=18556-18672 hash=f3df1881ef6ef425
...
# split-source: order=1000 original-lines=18673-18881 hash=06df9666f952d224
...
# split-source: order=1001 original-lines=18882-19151 hash=a27194aac2758898
...
# split-source: order=1002 original-lines=19152-19789 hash=cf10557a0f2e997a
...
# split-source: order=1003 original-lines=19790-20091 hash=8e4e177b25bb68fb
...
# split-source: order=1004 original-lines=20092-20786 hash=8338acd4de952750
...
# split-source: order=1005 original-lines=20787-20821 hash=fcb333eb4205c0af
...
# split-source: order=1006 original-lines=20822-20884 hash=bde047af53b04172
...
# split-source: order=1009 original-lines=21134-21180 hash=a1cad2dc59ad1cbb
...
# split-source: order=1011 original-lines=21356-21367 hash=b2142e5179ee4116
...
# split-source: order=1012 original-lines=21368-21386 hash=3983f97666e841f0
