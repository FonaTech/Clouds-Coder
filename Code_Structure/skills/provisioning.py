...
# split-source: order=778 original-lines=11004-11069 hash=893a5c7fc3fc79dc
...
# split-source: order=779 original-lines=11070-11073 hash=488e35a795d9caca
...
# split-source: order=781 original-lines=11080-11096 hash=5f75bbd1af19cd42
...
# split-source: order=782 original-lines=11097-11112 hash=1b6b77e50dc74a25
...
# split-source: order=783 original-lines=11113-11119 hash=9d5e4bda227c4064
...
# split-source: order=784 original-lines=11120-11209 hash=38b2da828440d41b
...
# split-source: order=785 original-lines=11210-11310 hash=7f3c2b04dcae2810
...
# split-source: order=786 original-lines=11311-11331 hash=0292dde0352a724f
...
# split-source: order=787 original-lines=11332-11387 hash=da1db978dee59a36
...
# split-source: order=788 original-lines=11388-11391 hash=380c4fa76ed211cc

def _sanitize_skill_slug(raw: str, fallback: str = "skills-gen") -> str:
    slug = re.sub(r"[^A-Za-z0-9._-]+", "-", str(raw or "").strip()).strip("-")
    return slug or fallback

# split-source: order=789 original-lines=11392-11424 hash=812fe6d2a2b42325
...
# split-source: order=790 original-lines=11425-11430 hash=577a94a4aa1e7aad
...
# split-source: order=791 original-lines=11431-11515 hash=e656c95087b6c2aa
...
# split-source: order=792 original-lines=11516-11789 hash=0a52d4a1b3b5c3a3
...
# split-source: order=793 original-lines=11790-11909 hash=7da06e07ba1dd983
...
# split-source: order=794 original-lines=11910-12026 hash=f3df1881ef6ef425
...
# split-source: order=795 original-lines=12027-12235 hash=06df9666f952d224
...
# split-source: order=796 original-lines=12236-12505 hash=a27194aac2758898
...
# split-source: order=797 original-lines=12506-13143 hash=cf10557a0f2e997a
...
# split-source: order=798 original-lines=13144-13445 hash=8e4e177b25bb68fb
...
# split-source: order=799 original-lines=13446-14140 hash=8338acd4de952750
...
# split-source: order=800 original-lines=14141-14175 hash=fcb333eb4205c0af
...
# split-source: order=801 original-lines=14176-14238 hash=4576a7d5bc863b3e
...
# split-source: order=804 original-lines=14488-14534 hash=a1cad2dc59ad1cbb
...
# split-source: order=806 original-lines=14710-14721 hash=b2142e5179ee4116
...
# split-source: order=807 original-lines=14722-14740 hash=3983f97666e841f0
