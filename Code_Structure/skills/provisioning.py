...
# split-source: order=857 original-lines=15723-15788 hash=893a5c7fc3fc79dc
...
# split-source: order=858 original-lines=15789-15792 hash=488e35a795d9caca
...
# split-source: order=860 original-lines=15799-15815 hash=5f75bbd1af19cd42
...
# split-source: order=861 original-lines=15816-15831 hash=1b6b77e50dc74a25
...
# split-source: order=862 original-lines=15832-15838 hash=9d5e4bda227c4064
...
# split-source: order=863 original-lines=15839-15928 hash=38b2da828440d41b
...
# split-source: order=864 original-lines=15929-16029 hash=7f3c2b04dcae2810
...
# split-source: order=865 original-lines=16030-16050 hash=0292dde0352a724f
...
# split-source: order=866 original-lines=16051-16106 hash=da1db978dee59a36
...
# split-source: order=867 original-lines=16107-16110 hash=380c4fa76ed211cc

def _sanitize_skill_slug(raw: str, fallback: str = "skills-gen") -> str:
    slug = re.sub(r"[^A-Za-z0-9._-]+", "-", str(raw or "").strip()).strip("-")
    return slug or fallback

# split-source: order=868 original-lines=16111-16143 hash=812fe6d2a2b42325
...
# split-source: order=869 original-lines=16144-16149 hash=577a94a4aa1e7aad
...
# split-source: order=870 original-lines=16150-16234 hash=e656c95087b6c2aa
...
# split-source: order=871 original-lines=16235-16508 hash=0a52d4a1b3b5c3a3
...
# split-source: order=872 original-lines=16509-16628 hash=7da06e07ba1dd983
...
# split-source: order=873 original-lines=16629-16745 hash=f3df1881ef6ef425
...
# split-source: order=874 original-lines=16746-16954 hash=06df9666f952d224
...
# split-source: order=875 original-lines=16955-17224 hash=a27194aac2758898
...
# split-source: order=876 original-lines=17225-17862 hash=cf10557a0f2e997a
...
# split-source: order=877 original-lines=17863-18164 hash=8e4e177b25bb68fb
...
# split-source: order=878 original-lines=18165-18859 hash=8338acd4de952750
...
# split-source: order=879 original-lines=18860-18894 hash=fcb333eb4205c0af
...
# split-source: order=880 original-lines=18895-18957 hash=bde047af53b04172
...
# split-source: order=883 original-lines=19207-19253 hash=a1cad2dc59ad1cbb
...
# split-source: order=885 original-lines=19429-19440 hash=b2142e5179ee4116
...
# split-source: order=886 original-lines=19441-19459 hash=3983f97666e841f0
