...
# split-source: order=1183 original-lines=116841-116850 hash=9c0c3a1fff932193
...
# split-source: order=1184 original-lines=116851-116866 hash=d2fe3603f0912f53
...
# split-source: order=1185 original-lines=116867-116870 hash=0128d9491e800215


def _studio_hash(value: str) -> str:
    return hashlib.sha256(str(value or "").encode("utf-8", errors="ignore")).hexdigest()

# split-source: order=1186 original-lines=116871-116880 hash=9448eda197483a51
...
# split-source: order=1187 original-lines=116881-118738 hash=e2c475d79831c3ea
