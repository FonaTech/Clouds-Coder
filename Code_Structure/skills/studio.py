...
# split-source: order=1183 original-lines=116960-116969 hash=9c0c3a1fff932193
...
# split-source: order=1184 original-lines=116970-116985 hash=d2fe3603f0912f53
...
# split-source: order=1185 original-lines=116986-116989 hash=0128d9491e800215


def _studio_hash(value: str) -> str:
    return hashlib.sha256(str(value or "").encode("utf-8", errors="ignore")).hexdigest()

# split-source: order=1186 original-lines=116990-116999 hash=9448eda197483a51
...
# split-source: order=1187 original-lines=117000-118857 hash=e2c475d79831c3ea
