...
- Symbols:
  ...
  - `INDEX_HTML` (constant, lines 37575-37762)
  - `APP_CSS` (constant, lines 37764-38152)
  - `APP_JS` (constant, lines 38154-41257)
...
- Symbols:
  ...
  - `SessionManager` (class, lines 36701-37573)
...
- Symbols:
  - `SessionState` (class, lines 12680-36699)
