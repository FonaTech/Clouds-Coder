...
- Symbols:
  - `main` (function, lines 50679-51529)
  - `_main_guard_51531` (main_guard, lines 51531-51532)
...
- Symbols:
  - `BackgroundManager` (class, lines 10411-10491)
...
- Symbols:
  - `MessageBus` (class, lines 10493-10547)
...
- Symbols:
  - `TaskManager` (class, lines 10283-10409)
...
- Symbols:
  - `WorktreeManager` (class, lines 10549-10760)
...
- Symbols:
  - `AppContext` (class, lines 47014-49336)
...
- Symbols:
  ...
  - `AGENT_TOOL_ALLOWLIST` (constant, lines 12057-12100)
  - `INDEX_HTML` (constant, lines 36204-36391)
  - `APP_CSS` (constant, lines 36393-36771)
  - `APP_JS` (constant, lines 36773-39752)
  - `APP_TS` (constant, lines 39754-39781)
  - `SKILLS_INDEX_HTML` (constant, lines 39783-39937)
  - `SKILLS_EXTRA_CSS` (constant, lines 39939-40034)
  - `SKILLS_APP_JS` (constant, lines 40036-40177)
  - `RAG_TERM_GROUPS` (constant, lines 40179-40189)
  - `RAG_RESEARCH_HINTS` (constant, lines 40190-40211)
  - `RAG_CODE_HINTS` (constant, lines 40212-40222)
  - `RAG_SHORT_TOKEN_ALLOWLIST` (constant, lines 40223-40238)
  - `RAG_EN_STOPWORDS` (constant, lines 40239-40311)
  - `RAG_ZH_STOPWORDS` (constant, lines 40312-40348)
  - `RAG_GENERIC_ENTITY_TERMS_EN` (constant, lines 40349-40427)
  - `RAG_GENERIC_ENTITY_TERMS_ZH` (constant, lines 40428-40470)
  - `RAG_STRUCTURAL_ENTITY_PATTERNS` (constant, lines 40471-40489)
  - `CODE_LIBRARY_IGNORED_DIRS` (constant, lines 40812-40817)
  - `CODE_LIBRARY_LANGUAGE_BY_EXT` (constant, lines 40818-40874)
  - `CODE_LIBRARY_SPECIAL_FILENAMES` (constant, lines 40875-40881)
  - `RAG_ADMIN_INDEX_HTML` (constant, lines 45488-45645)
  - `RAG_ADMIN_CSS` (constant, lines 45647-45737)
  - `RAG_ADMIN_JS` (constant, lines 45739-46965)
  - `CODE_ADMIN_INDEX_HTML` (constant, lines 46967-46976)
  - `CODE_ADMIN_CSS` (constant, lines 46977-47007)
  - `CODE_ADMIN_JS` (constant, lines 47008-47012)
...
- Symbols:
  - `OllamaError` (class, lines 10762-10765)
  - `OllamaClient` (class, lines 10767-11819)
...
- Symbols:
  - `_code_module_name` (function, lines 40908-40922)
  - `_code_choose_community` (function, lines 40925-40932)
  - `_code_query_terms` (function, lines 40935-40947)
  - `TFGraphIDFIndex` (class, lines 41923-43281)
  - `CodeGraphIndex` (class, lines 44721-45133)
...
- Symbols:
  - `_rag_parse_file_worker` (function, lines 43834-43848)
  - `RAGIngestionService` (class, lines 43851-44718)
  - `CodeIngestionService` (class, lines 45402-45486)
...
- Symbols:
  ...
  - `_rag_safe_name` (function, lines 40492-40495)
  - `_rag_detect_language` (function, lines 40498-40512)
  - `_rag_cjk_ngrams` (function, lines 40515-40527)
  - `_rag_is_noise_token` (function, lines 40530-40549)
  - `_rag_entity_allowed` (function, lines 40552-40564)
  - `_rag_filter_entities` (function, lines 40567-40581)
  - `_rag_filename_entity_aliases` (function, lines 40584-40617)
  - `_rag_apply_filename_entity_policy` (function, lines 40620-40650)
  - `_rag_choose_community` (function, lines 40653-40670)
  - `_rag_tokenize` (function, lines 40673-40703)
  - `_rag_expand_tokens` (function, lines 40706-40720)
  - `_rag_extract_entities` (function, lines 40723-40739)
  - `_rag_classify_document` (function, lines 40742-40776)
  - `_rag_chunk_text` (function, lines 40779-40809)
  - `_code_language_from_name` (function, lines 40884-40900)
  - `_code_is_test_path` (function, lines 40903-40905)
  - `CodeContentParser` (class, lines 40950-41410)
  - `RAGContentParser` (class, lines 41413-41920)
...
- Symbols:
  - `RAGLibraryStore` (class, lines 43284-43831)
  - `CodeLibraryStore` (class, lines 45136-45399)
...
- Symbols:
  - `AgentHTTPServer` (class, lines 49338-49366)
  - `Handler` (class, lines 49368-50167)
  - `SkillsHandler` (class, lines 50169-50364)
  - `RagAdminHandler` (class, lines 50366-50520)
  - `CodeAdminHandler` (class, lines 50523-50677)
...
- Symbols:
  - `SessionManager` (class, lines 35330-36202)
...
- Symbols:
  - `SessionState` (class, lines 12102-35328)
...
- Symbols:
  ...
  - `_BUILTIN_SKILLS` (assignment, lines 8899-8985)
  - `SkillStore` (class, lines 8987-10281)
...
- Symbols:
  ...
  - `tool_def` (function, lines 11821-11833)
  - `TOOLS` (constant, lines 11835-12011)
  - `TOOL_REQUIRED_ARGS` (constant, lines 12013-12013)
  - `TOOL_SPEC_BY_NAME` (constant, lines 12014-12014)
  - `TOOL_NAME_FUZZY_MAP` (constant, lines 12026-12026)
  - `canonicalize_tool_name` (function, lines 12044-12055)
