...
- Symbols:
  - `main` (function, lines 47861-48711)
  - `_main_guard_48713` (main_guard, lines 48713-48714)
...
- Symbols:
  - `BackgroundManager` (class, lines 10022-10102)
...
- Symbols:
  - `MessageBus` (class, lines 10104-10158)
...
- Symbols:
  - `EventHub` (class, lines 4687-4732)
...
- Symbols:
  - `TaskManager` (class, lines 9894-10020)
...
- Symbols:
  - `TodoManager` (class, lines 4734-4978)
...
- Symbols:
  - `WorktreeManager` (class, lines 10160-10371)
...
- Symbols:
  - `AppContext` (class, lines 44342-46651)
...
- Symbols:
  ...
  - `call_backend_i18n_en_update_l1362` (expression, lines 1362-1461)
  - `call_backend_i18n_zh_cn_update_l1462` (expression, lines 1462-1561)
  ...
  - `EMBEDDED_SKILLS_ARCHIVE_B64` (constant, lines 4980-5499)
  - `EMBEDDED_SKILLS_ARCHIVE_SHA256` (constant, lines 5500-5500)
  - `EMBEDDED_SKILLS_ARCHIVE_FILES` (constant, lines 5501-5524)
  - `BUILTIN_CLAWHUB_SKILLS_VERSION` (constant, lines 8168-8168)
  - `EMBEDDED_CLAWHUB_SKILLS_ARCHIVE_B64` (constant, lines 8170-8414)
  - `SKILL_PROTOCOL_LOCAL` (constant, lines 8470-8470)
  - `SKILL_PROTOCOL_CLAWHUB` (constant, lines 8471-8471)
  - `SKILL_PROTOCOL_HTTP_JSON` (constant, lines 8472-8472)
  - `SKILL_PROTOCOL_SPECS` (constant, lines 8474-8505)
  - `AGENT_TOOL_ALLOWLIST` (constant, lines 11668-11711)
  - `INDEX_HTML` (constant, lines 33549-33736)
  - `APP_CSS` (constant, lines 33738-34099)
  - `APP_JS` (constant, lines 34101-37081)
  - `APP_TS` (constant, lines 37083-37110)
  - `SKILLS_INDEX_HTML` (constant, lines 37112-37266)
  - `SKILLS_EXTRA_CSS` (constant, lines 37268-37363)
  - `SKILLS_APP_JS` (constant, lines 37365-37505)
  - `RAG_TERM_GROUPS` (constant, lines 37507-37517)
  - `RAG_RESEARCH_HINTS` (constant, lines 37518-37539)
  - `RAG_CODE_HINTS` (constant, lines 37540-37550)
  - `RAG_SHORT_TOKEN_ALLOWLIST` (constant, lines 37551-37566)
  - `RAG_EN_STOPWORDS` (constant, lines 37567-37639)
  - `RAG_ZH_STOPWORDS` (constant, lines 37640-37676)
  - `RAG_GENERIC_ENTITY_TERMS_EN` (constant, lines 37677-37755)
  - `RAG_GENERIC_ENTITY_TERMS_ZH` (constant, lines 37756-37798)
  - `RAG_STRUCTURAL_ENTITY_PATTERNS` (constant, lines 37799-37817)
  - `CODE_LIBRARY_IGNORED_DIRS` (constant, lines 38140-38145)
  - `CODE_LIBRARY_LANGUAGE_BY_EXT` (constant, lines 38146-38202)
  - `CODE_LIBRARY_SPECIAL_FILENAMES` (constant, lines 38203-38209)
  - `RAG_ADMIN_INDEX_HTML` (constant, lines 42816-42973)
  - `RAG_ADMIN_CSS` (constant, lines 42975-43065)
  - `RAG_ADMIN_JS` (constant, lines 43067-44293)
  - `CODE_ADMIN_INDEX_HTML` (constant, lines 44295-44304)
  - `CODE_ADMIN_CSS` (constant, lines 44305-44335)
  - `CODE_ADMIN_JS` (constant, lines 44336-44340)
...
- Symbols:
  ...
  - `detect_repo_root` (function, lines 2275-2289)
  - `REPO_ROOT` (constant, lines 2291-2291)
...
- Symbols:
  ...
  - `default_multimodal_capabilities` (function, lines 1967-1975)
  - `_to_bool_like` (function, lines 1978-1988)
  - `infer_model_multimodal_capabilities` (function, lines 1991-2035)
  - `parse_capability_overrides` (function, lines 2038-2075)
  - `merge_multimodal_capabilities` (function, lines 2078-2085)
  - `parse_media_endpoints` (function, lines 2088-2102)
  - `load_llm_config_from_source` (function, lines 3397-3431)
  - `parse_llm_config_profiles` (function, lines 3433-3787)
  - `looks_like_llm_config` (function, lines 3789-3857)
...
- Symbols:
  - `OllamaError` (class, lines 10373-10376)
  - `OllamaClient` (class, lines 10378-11430)
...
- Symbols:
  - `probe_ollama_environment` (function, lines 3058-3071)
  - `list_ollama_models` (function, lines 3073-3075)
  - `_OLLAMA_TAG_CACHE_LOCK` (assignment, lines 3077-3077)
  - `_OLLAMA_TAG_CACHE` (assignment, lines 3078-3078)
  - `list_ollama_models_cached` (function, lines 3088-3125)
  - `resolve_ollama_model` (function, lines 3127-3137)
  - `infer_thinking_model` (function, lines 3139-3141)
  - `split_thinking_content` (function, lines 3143-3184)
  - `strip_thinking_content` (function, lines 3186-3187)
  - `check_ollama_model_ready` (function, lines 3189-3213)
  - `list_loaded_ollama_models` (function, lines 3215-3228)
  - `wake_ollama_model` (function, lines 3230-3260)
  - `try_pull_ollama_model` (function, lines 3262-3280)
  - `ordered_model_candidates` (function, lines 3282-3300)
  - `pick_working_ollama_model` (function, lines 3302-3318)
  - `extract_base_url` (function, lines 3351-3359)
  - `complete_chat_endpoint` (function, lines 3361-3370)
  - `_is_http_url` (function, lines 3372-3377)
  - `_resolve_local_path` (function, lines 3379-3395)
...
- Symbols:
  - `_code_module_name` (function, lines 38236-38250)
  - `_code_choose_community` (function, lines 38253-38260)
  - `_code_query_terms` (function, lines 38263-38275)
  - `TFGraphIDFIndex` (class, lines 39251-40609)
  - `CodeGraphIndex` (class, lines 42049-42461)
...
- Symbols:
  - `_rag_parse_file_worker` (function, lines 41162-41176)
  - `RAGIngestionService` (class, lines 41179-42046)
  - `CodeIngestionService` (class, lines 42730-42814)
...
- Symbols:
  - `normalize_rel_preview_path` (function, lines 4463-4474)
  - `is_code_preview_candidate` (function, lines 4477-4485)
  - `preview_kind_for_path` (function, lines 4488-4498)
  - `build_code_preview_rows` (function, lines 4501-4685)
  - `_rag_safe_name` (function, lines 37820-37823)
  - `_rag_detect_language` (function, lines 37826-37840)
  - `_rag_cjk_ngrams` (function, lines 37843-37855)
  - `_rag_is_noise_token` (function, lines 37858-37877)
  - `_rag_entity_allowed` (function, lines 37880-37892)
  - `_rag_filter_entities` (function, lines 37895-37909)
  - `_rag_filename_entity_aliases` (function, lines 37912-37945)
  - `_rag_apply_filename_entity_policy` (function, lines 37948-37978)
  - `_rag_choose_community` (function, lines 37981-37998)
  - `_rag_tokenize` (function, lines 38001-38031)
  - `_rag_expand_tokens` (function, lines 38034-38048)
  - `_rag_extract_entities` (function, lines 38051-38067)
  - `_rag_classify_document` (function, lines 38070-38104)
  - `_rag_chunk_text` (function, lines 38107-38137)
  - `_code_language_from_name` (function, lines 38212-38228)
  - `_code_is_test_path` (function, lines 38231-38233)
  - `CodeContentParser` (class, lines 38278-38738)
  - `RAGContentParser` (class, lines 38741-39248)
...
- Symbols:
  - `RAGLibraryStore` (class, lines 40612-41159)
  - `CodeLibraryStore` (class, lines 42464-42727)
...
- Symbols:
  - `AgentHTTPServer` (class, lines 46653-46681)
  - `Handler` (class, lines 46683-47351)
  - `SkillsHandler` (class, lines 47353-47546)
  - `RagAdminHandler` (class, lines 47548-47702)
  - `CodeAdminHandler` (class, lines 47705-47859)
...
- Symbols:
  - `SessionManager` (class, lines 32695-33547)
...
- Symbols:
  - `SessionState` (class, lines 11713-32693)
...
- Symbols:
  - `ensure_embedded_skills_at_root` (function, lines 5527-5579)
  - `ensure_embedded_skills` (function, lines 5582-5583)
  - `detect_upload_parser_capabilities` (function, lines 5591-5606)
  - `_render_cap_markdown` (function, lines 5608-5622)
  - `_write_text_if_changed` (function, lines 5624-5629)
  - `ensure_generated_document_skills` (function, lines 5631-5719)
  - `ensure_generated_image_coding_feedback_skill` (function, lines 5721-5820)
  - `_skill_knowledge_files` (function, lines 5822-5841)
  - `analyze_skill_building_knowledge` (function, lines 5843-5897)
  - `_sanitize_skill_slug` (function, lines 5899-5901)
  - `_build_skills_gen_skill_content` (function, lines 5903-5934)
  - `ensure_generated_skills_gen_skill` (function, lines 5936-5940)
  - `ensure_generated_execution_recovery_skill` (function, lines 5942-6020)
  - `ensure_generated_html_frontend_report_skills` (function, lines 6022-6227)
  - `ensure_generated_deep_research_skills` (function, lines 6229-6497)
  - `ensure_generated_research_scientific_skills` (function, lines 6499-7135)
  - `ensure_generated_rag_mastery_skills` (function, lines 7141-7437)
  - `ensure_generated_multimodal_comprehension_skills` (function, lines 7443-8132)
  - `ensure_generated_runtime_skills_manifest` (function, lines 8135-8166)
  - `ensure_embedded_clawhub_skills` (function, lines 8417-8454)
  - `ensure_runtime_skills` (function, lines 8456-8468)
  - `_BUILTIN_SKILLS` (assignment, lines 8510-8596)
  - `SkillStore` (class, lines 8598-9892)
...
- Cross-module imports: none
- Symbols:
  - `compress_text_blob` (function, lines 2916-2921)
  - `decompress_text_blob` (function, lines 2923-2931)
...
- Symbols:
  - `CryptoBox` (class, lines 3867-3984)
...
- Cross-module imports: none
- Symbols:
  - `EmptyActionError` (class, lines 3081-3082)
  - `CircuitBreakerTriggered` (class, lines 3085-3086)
...
- Symbols:
  ...
  - `safe_path` (function, lines 2293-2302)
  - `_safe_js_filename` (function, lines 2304-2311)
  - `_sha256_bytes` (function, lines 2313-2314)
  - `_sha256_file` (function, lines 2316-2324)
  - `_download_http_bytes` (function, lines 2326-2334)
  - `offline_js_lib_root` (function, lines 2336-2337)
  - `_offline_js_entry_relative_path` (function, lines 2339-2343)
  - `_archive_member_relative_path` (function, lines 2345-2354)
  - `_path_size_bytes` (function, lines 2356-2371)
  - `_extract_archive_to_dir` (function, lines 2373-2413)
  - `_package_required_paths` (function, lines 2415-2421)
  - `_package_install_ready` (function, lines 2423-2431)
  - `_postprocess_offline_js_package` (function, lines 2433-2468)
  - `_ensure_offline_js_package` (function, lines 2470-2509)
  - `_render_offline_js_catalog_md` (function, lines 2511-2527)
  - `load_offline_js_lib_index` (function, lines 2529-2538)
  - `ensure_offline_js_libs` (function, lines 2540-2684)
  - `_normalize_external_js_url` (function, lines 2686-2690)
  - `is_external_js_src` (function, lines 2692-2694)
  - `match_offline_js_catalog_by_url` (function, lines 2696-2712)
  - `cache_external_js_url` (function, lines 2714-2746)
  - `try_read_text` (function, lines 4189-4197)
...
- Symbols:
  ...
  - `json_dumps` (function, lines 2265-2266)
  - `parse_tool_arguments` (function, lines 2960-2969)
  - `repair_truncated_json_object` (function, lines 2971-3024)
  - `parse_tool_arguments_with_error` (function, lines 3026-3056)
  - `parse_json_object` (function, lines 3320-3325)
  - `extract_json_object_from_text` (function, lines 3327-3349)
  - `_json_default_copy` (function, lines 4199-4204)
  - `_read_json_file` (function, lines 4206-4226)
  - `_write_json_file` (function, lines 4228-4255)
  - `tool_def` (function, lines 11432-11444)
  - `TOOLS` (constant, lines 11446-11622)
  - `TOOL_REQUIRED_ARGS` (constant, lines 11624-11624)
  - `TOOL_SPEC_BY_NAME` (constant, lines 11625-11625)
  - `TOOL_NAME_FUZZY_MAP` (constant, lines 11637-11637)
  - `canonicalize_tool_name` (function, lines 11655-11666)
...
- Cross-module imports: none
- Symbols:
  - `guess_mime_from_name` (function, lines 2105-2107)
  - `_convert_image_to_safe_format` (function, lines 2110-2127)
  - `guess_ext_from_mime` (function, lines 2130-2136)
...
- Symbols:
  ...
  - `now_ts` (function, lines 2138-2139)
  - `_benign_socket_log_lock` (assignment, lines 2142-2142)
  - `_benign_socket_log_state` (assignment, lines 2143-2143)
  - `is_benign_socket_error` (function, lines 2161-2179)
  - `_socket_error_code` (function, lines 2182-2191)
  - `_log_benign_socket_error_limited` (function, lines 2194-2228)
  - `swallow_benign_socket_error` (function, lines 2231-2235)
  - `normalize_timeout_seconds` (function, lines 2238-2251)
  - `detect_local_lan_ip` (function, lines 2253-2263)
  - `make_id` (function, lines 2268-2269)
  - `sanitize_profile_id` (function, lines 2271-2273)
  - `user_id_from_ip` (function, lines 3859-3865)
  - `_meta_string_list` (function, lines 4176-4187)
  - `_module_exists` (function, lines 5585-5589)
...
- Symbols:
  ...
  - `filter_runtime_noise_lines` (function, lines 2146-2158)
  - `trim` (function, lines 2748-2750)
  - `_fmt_export_ts` (function, lines 2753-2761)
  - `_html_esc` (function, lines 2764-2765)
  - `_text_to_minimal_pdf` (function, lines 2768-2914)
  - `normalize_work_text` (function, lines 2933-2958)
  - `parse_front_matter` (function, lines 3986-4173)
  - `make_unified_diff` (function, lines 4257-4274)
  - `_skip_row` (function, lines 4276-4280)
  - `_row_is_hot` (function, lines 4283-4284)
  - `_hotspot_index` (function, lines 4287-4308)
  - `_compress_rows_keep_hotspot` (function, lines 4311-4358)
  - `make_numbered_diff` (function, lines 4361-4446)
  - `render_numbered_diff_text` (function, lines 4448-4460)
