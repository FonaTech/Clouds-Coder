...
| `admin/constants.py` | 16 | 16 | — | 3920–118866 |
...
| `ide/assets.py` | 8 | 3 | — | 115805–116934 |
...
| `ide/handler.py` | 1 | 1 | `admin/auth.py`, `app/context.py`, `collaboration/core.py`, `config/constants.py`, `config/settings.py`, `ide/auth.py`, `ide/errors.py`, `ide/events.py`, `session/manager.py`, `session/state.py`, `utils/http.py`, `utils/json_utils.py`, `utils/media.py`, `utils/misc.py`, `utils/text.py` | 134204–135860 |
...
| `mcp/service.py` | 1 | 1 | `app/context.py`, `config/constants.py`, `utils/files.py`, `utils/http.py`, `utils/json_utils.py`, `utils/misc.py`, `utils/text.py` | 136332–136549 |
| `rag/assets.py` | 6 | 6 | — | 113198–115804 |
| `rag/constants.py` | 77 | 77 | — | 4285–106156 |
| `rag/index.py` | 5 | 5 | `config/constants.py`, `rag/constants.py`, `rag/ingestion.py`, `rag/parsers.py`, `utils/misc.py`, `utils/text.py` | 106181–112818 |
| `rag/ingestion.py` | 13 | 13 | `config/constants.py`, `config/settings.py`, `rag/constants.py`, `rag/parsers.py`, `rag/store.py`, `session/state.py`, `utils/files.py`, `utils/json_utils.py`, `utils/media.py`, `utils/misc.py`, `utils/text.py` | 105503–113197 |
| `rag/parsers.py` | 31 | 31 | `agent/process.py`, `config/constants.py`, `rag/constants.py`, `rag/ingestion.py`, `utils/files.py`, `utils/json_utils.py`, `utils/media.py`, `utils/text.py` | 105126–107352 |
| `rag/store.py` | 7 | 7 | `config/constants.py`, `config/settings.py`, `ide/preview.py`, `rag/constants.py`, `rag/index.py`, `rag/ingestion.py`, `rag/parsers.py`, `skills/provisioning.py`, `utils/files.py`, `utils/json_utils.py`, `utils/media.py`, `utils/misc.py`, `utils/sqlite.py`, `utils/text.py` | 109048–113109 |
...
| `server/rag_admin.py` | 3 | 3 | `admin/auth.py`, `app/context.py`, `config/constants.py`, `rag/constants.py`, `utils/http.py`, `utils/media.py`, `utils/misc.py`, `utils/text.py` | 133532–134203 |
| `server/skills.py` | 1 | 1 | `admin/auth.py`, `app/context.py`, `config/constants.py`, `config/paths.py`, `config/settings.py`, `session/manager.py`, `skills/provisioning.py`, `skills/studio.py`, `utils/http.py`, `utils/media.py`, `utils/misc.py`, `utils/text.py` | 132889–133531 |
| `session/manager.py` | 2 | 2 | `agent/process.py`, `config/constants.py`, `config/paths.py`, `config/settings.py`, `llm/client.py`, `llm/utils.py`, `rag/store.py`, `session/state.py`, `skills/store.py`, `utils/crypto.py`, `utils/files.py`, `utils/json_utils.py`, `utils/misc.py`, `utils/text.py` | 7607–93266 |
| `session/state.py` | 1 | 1 | `admin/constants.py`, `agent/background.py`, `agent/bus.py`, `agent/errors.py`, `agent/events.py`, `agent/process.py`, `agent/tasks.py`, `agent/todo.py`, `agent/tools.py`, `agent/worktree.py`, `collaboration/core.py`, `config/constants.py`, `config/paths.py`, `config/settings.py`, `ide/events.py`, `ide/preview.py`, `ide/sandbox.py`, `llm/client.py`, `llm/constants.py`, `llm/utils.py`, `mcp/constants.py`, `mcp/driver.py`, `rag/constants.py`, `rag/parsers.py`, `rag/web_search.py`, `server/http.py`, `skills/provisioning.py`, `skills/store.py`, `utils/compress.py`, `utils/crypto.py`, `utils/errors.py`, `utils/files.py`, `utils/http.py`, `utils/json_utils.py`, `utils/media.py`, `utils/misc.py`, `utils/text.py` | 30013–90761 |
...
| `skills/studio.py` | 5 | 5 | `agent/process.py`, `collaboration/core.py`, `config/constants.py`, `config/settings.py`, `ide/sandbox.py`, `llm/client.py`, `llm/constants.py`, `utils/json_utils.py`, `utils/misc.py`, `utils/sqlite.py`, `utils/text.py` | 116960–118857 |
...
| `utils/sqlite.py` | 3 | 3 | — | 74–136634 |
| `utils/text.py` | 30 | 30 | `config/constants.py` | 4272–16768 |
| `web/admin_assets.py` | 3 | 3 | — | 99309–100191 |
| `web/assets.py` | 5 | 4 | — | 93267–98906 |
| `web/skills_assets.py` | 3 | 3 | — | 98907–99308 |
...
- order 1191: `ADMIN_SKILLS_REVIEW_HTML` (constant), lines 118863-118864, exports `ADMIN_SKILLS_REVIEW_HTML`
- order 1192: `ADMIN_SKILLS_REVIEW_CSS` (constant), lines 118865-118865, exports `ADMIN_SKILLS_REVIEW_CSS`
- order 1193: `ADMIN_SKILLS_REVIEW_JS` (constant), lines 118866-118866, exports `ADMIN_SKILLS_REVIEW_JS`
...
- order 1194: `AppContext` (class), lines 118867-129746, exports `AppContext`

### `app/main.py`

- order 1210: `main` (function), lines 136728-138676, exports `main`
- order 1211: `_main_guard_138678` (main_guard), lines 138677-138679, exports —

### `app/services.py`

- order 1196: `TelemetryStore` (class), lines 129787-130162, exports `TelemetryStore`
- order 1197: `ApplicationRegistry` (class), lines 130163-130972, exports `ApplicationRegistry`
...
- order 1208: `collaboration_file_watcher_loop` (function), lines 136635-136709, exports `collaboration_file_watcher_loop`
- order 1209: `collaboration_watcher_health` (function), lines 136710-136727, exports `collaboration_watcher_health`
...
- order 1175: `STUDIO_DEVICE_COOKIE` (constant), lines 116935-116952, exports `STUDIO_DEVICE_COOKIE`
- order 1176: `STUDIO_SESSION_COOKIE` (constant), lines 116953-116953, exports `STUDIO_SESSION_COOKIE`
- order 1177: `STUDIO_DEVICE_TTL` (constant), lines 116954-116954, exports `STUDIO_DEVICE_TTL`
- order 1178: `STUDIO_SESSION_TTL` (constant), lines 116955-116955, exports `STUDIO_SESSION_TTL`
- order 1179: `STUDIO_MAX_FILE_BYTES` (constant), lines 116956-116956, exports `STUDIO_MAX_FILE_BYTES`
- order 1180: `STUDIO_MAX_PROJECT_BYTES` (constant), lines 116957-116957, exports `STUDIO_MAX_PROJECT_BYTES`
- order 1181: `STUDIO_MAX_FILES` (constant), lines 116958-116958, exports `STUDIO_MAX_FILES`
- order 1182: `STUDIO_MAX_JOB_SECONDS` (constant), lines 116959-116959, exports `STUDIO_MAX_JOB_SECONDS`
- order 1188: `STUDIO_INDEX_HTML` (constant), lines 118858-118860, exports `STUDIO_INDEX_HTML`
- order 1189: `STUDIO_CSS` (constant), lines 118861-118861, exports `STUDIO_CSS`
- order 1190: `STUDIO_JS` (constant), lines 118862-118862, exports `STUDIO_JS`
...
- order 1167: `IDE_INDEX_HTML` (constant), lines 115805-115960, exports `IDE_INDEX_HTML`
- order 1168: `IDE_CSS` (constant), lines 115961-116002, exports `IDE_CSS`
- order 1169: `IDE_JS` (constant), lines 116003-116196, exports `IDE_JS`
- order 1170: `IDE_CSS` (constant), lines 116197-116218, exports `IDE_CSS`
- order 1171: `IDE_JS` (constant), lines 116219-116482, exports `IDE_JS`
- order 1172: `IDE_JS` (constant), lines 116483-116611, exports `IDE_JS`
- order 1173: `IDE_JS` (constant), lines 116612-116835, exports `IDE_JS`
- order 1174: `IDE_JS` (constant), lines 116836-116934, exports `IDE_JS`
...
- order 1204: `IdeHandler` (class), lines 134204-135860, exports `IdeHandler`
...
- order 1206: `McpServiceHandler` (class), lines 136332-136549, exports `McpServiceHandler`

### `rag/assets.py`

- order 1161: `RAG_ADMIN_INDEX_HTML` (constant), lines 113198-113430, exports `RAG_ADMIN_INDEX_HTML`
- order 1162: `RAG_ADMIN_CSS` (constant), lines 113431-113534, exports `RAG_ADMIN_CSS`
- order 1163: `RAG_ADMIN_JS` (constant), lines 113535-115755, exports `RAG_ADMIN_JS`
- order 1164: `CODE_ADMIN_INDEX_HTML` (constant), lines 115756-115768, exports `CODE_ADMIN_INDEX_HTML`
- order 1165: `CODE_ADMIN_CSS` (constant), lines 115769-115799, exports `CODE_ADMIN_CSS`
- order 1166: `CODE_ADMIN_JS` (constant), lines 115800-115804, exports `CODE_ADMIN_JS`
...
- order 1093: `RAG_TERM_GROUPS` (constant), lines 100192-104825, exports `RAG_TERM_GROUPS`
- order 1094: `RAG_RESEARCH_HINTS` (constant), lines 104826-104847, exports `RAG_RESEARCH_HINTS`
- order 1095: `RAG_CODE_HINTS` (constant), lines 104848-104858, exports `RAG_CODE_HINTS`
- order 1096: `RAG_SHORT_TOKEN_ALLOWLIST` (constant), lines 104859-104874, exports `RAG_SHORT_TOKEN_ALLOWLIST`
- order 1097: `RAG_EN_STOPWORDS` (constant), lines 104875-104947, exports `RAG_EN_STOPWORDS`
- order 1098: `RAG_ZH_STOPWORDS` (constant), lines 104948-104984, exports `RAG_ZH_STOPWORDS`
- order 1099: `RAG_GENERIC_ENTITY_TERMS_EN` (constant), lines 104985-105063, exports `RAG_GENERIC_ENTITY_TERMS_EN`
- order 1100: `RAG_GENERIC_ENTITY_TERMS_ZH` (constant), lines 105064-105106, exports `RAG_GENERIC_ENTITY_TERMS_ZH`
- order 1101: `RAG_STRUCTURAL_ENTITY_PATTERNS` (constant), lines 105107-105125, exports `RAG_STRUCTURAL_ENTITY_PATTERNS`
- order 1133: `CODE_LIBRARY_IGNORED_DIRS` (constant), lines 106083-106092, exports `CODE_LIBRARY_IGNORED_DIRS`
- order 1134: `CODE_LIBRARY_LANGUAGE_BY_EXT` (constant), lines 106093-106149, exports `CODE_LIBRARY_LANGUAGE_BY_EXT`
- order 1135: `CODE_LIBRARY_SPECIAL_FILENAMES` (constant), lines 106150-106156, exports `CODE_LIBRARY_SPECIAL_FILENAMES`

### `rag/index.py`

- order 1138: `_code_module_name` (function), lines 106181-106197, exports `_code_module_name`
- order 1139: `_code_choose_community` (function), lines 106198-106207, exports `_code_choose_community`
- order 1140: `_code_query_terms` (function), lines 106208-106222, exports `_code_query_terms`
- order 1149: `TFGraphIDFIndex` (class), lines 107353-109047, exports `TFGraphIDFIndex`
- order 1158: `CodeGraphIndex` (class), lines 112330-112818, exports `CodeGraphIndex`

### `rag/ingestion.py`

- order 1117: `_rag_trigram_set` (function), lines 105503-105510, exports `_rag_trigram_set`
- order 1118: `_rag_jaccard_sim` (function), lines 105511-105520, exports `_rag_jaccard_sim`
- order 1119: `_rag_mmr_select` (function), lines 105521-105570, exports `_rag_mmr_select`
- order 1124: `_rag_embed_text` (function), lines 105705-105728, exports `_rag_embed_text`
- order 1125: `_rag_embed_batch` (function), lines 105729-105737, exports `_rag_embed_batch`
- order 1126: `_rag_window_for_query` (function), lines 105738-105752, exports `_rag_window_for_query`
- order 1127: `_rag_focused_excerpt` (function), lines 105753-105795, exports `_rag_focused_excerpt`
- order 1128: `_rag_query_variants` (function), lines 105796-105835, exports `_rag_query_variants`
- order 1129: `_rag_parse_segments` (function), lines 105836-105898, exports `_rag_parse_segments`
- order 1130: `_rag_boundary_split` (function), lines 105899-105956, exports `_rag_boundary_split`
- order 1156: `_rag_parse_file_worker` (function), lines 111431-111447, exports `_rag_parse_file_worker`
- order 1157: `RAGIngestionService` (class), lines 111448-112329, exports `RAGIngestionService`
- order 1160: `CodeIngestionService` (class), lines 113110-113197, exports `CodeIngestionService`

### `rag/parsers.py`

- order 1102: `EvidenceRecord` (class), lines 105126-105160, exports `EvidenceRecord`
- order 1103: `_rag_float` (function), lines 105161-105167, exports `_rag_float`
- order 1104: `_rag_evidence_source_type` (function), lines 105168-105184, exports `_rag_evidence_source_type`
- order 1105: `_rag_normalize_evidence_record` (function), lines 105185-105240, exports `_rag_normalize_evidence_record`
- order 1106: `_rag_validate_evidence_record` (function), lines 105241-105283, exports `_rag_validate_evidence_record`
- order 1107: `_rag_evidence_batches` (function), lines 105284-105301, exports `_rag_evidence_batches`
- order 1108: `_rag_safe_name` (function), lines 105302-105307, exports `_rag_safe_name`
- order 1109: `_rag_detect_language` (function), lines 105308-105324, exports `_rag_detect_language`
- order 1110: `_rag_cjk_ngrams` (function), lines 105325-105339, exports `_rag_cjk_ngrams`
- order 1111: `_rag_is_noise_token` (function), lines 105340-105361, exports `_rag_is_noise_token`
- order 1112: `_rag_entity_allowed` (function), lines 105362-105376, exports `_rag_entity_allowed`
- order 1113: `_rag_filter_entities` (function), lines 105377-105393, exports `_rag_filter_entities`
- order 1114: `_rag_filename_entity_aliases` (function), lines 105394-105429, exports `_rag_filename_entity_aliases`
- order 1115: `_rag_apply_filename_entity_policy` (function), lines 105430-105462, exports `_rag_apply_filename_entity_policy`
- order 1116: `_rag_choose_community` (function), lines 105463-105502, exports `_rag_choose_community`
- order 1120: `_rag_tokenize` (function), lines 105571-105624, exports `_rag_tokenize`
- order 1121: `_rag_expand_tokens` (function), lines 105625-105648, exports `_rag_expand_tokens`
- order 1122: `_rag_extract_entities` (function), lines 105649-105667, exports `_rag_extract_entities`
- order 1123: `_rag_classify_document` (function), lines 105668-105704, exports `_rag_classify_document`
- order 1131: `_rag_structure_outline` (function), lines 105957-105995, exports `_rag_structure_outline`
- order 1132: `_rag_chunk_text` (function), lines 105996-106082, exports `_rag_chunk_text`
- order 1136: `_code_language_from_name` (function), lines 106157-106175, exports `_code_language_from_name`
- order 1137: `_code_is_test_path` (function), lines 106176-106180, exports `_code_is_test_path`
- order 1141: `_CallCollector` (class), lines 106223-106237, exports `_CallCollector`
- order 1142: `_ALGO_COMPLEXITY_RE` (assignment), lines 106238-106240, exports `_ALGO_COMPLEXITY_RE`
- order 1143: `_ALGO_STEP_RE` (assignment), lines 106241-106241, exports `_ALGO_STEP_RE`
- order 1144: `_ALGO_MATH_VARS` (assignment), lines 106242-106242, exports `_ALGO_MATH_VARS`
- order 1145: `_ALGO_DOC_KEYWORDS` (assignment), lines 106243-106243, exports `_ALGO_DOC_KEYWORDS`
- order 1146: `_detect_algo_chunk` (function), lines 106244-106269, exports `_detect_algo_chunk`
- order 1147: `CodeContentParser` (class), lines 106270-106836, exports `CodeContentParser`
- order 1148: `RAGContentParser` (class), lines 106837-107352, exports `RAGContentParser`

### `rag/store.py`

- order 1150: `RAGLibraryStore` (class), lines 109048-109686, exports `RAGLibraryStore`
- order 1151: `WikiStore` (class), lines 109687-110242, exports `WikiStore`
- order 1152: `UserMemoryStore` (class), lines 110243-110918, exports `UserMemoryStore`
- order 1153: `UserInteractionOptimizer` (class), lines 110919-110987, exports `UserInteractionOptimizer`
- order 1154: `UserIntentProfiler` (class), lines 110988-111029, exports `UserIntentProfiler`
- order 1155: `WorkflowMemoryStore` (class), lines 111030-111430, exports `WorkflowMemoryStore`
- order 1159: `CodeLibraryStore` (class), lines 112819-113109, exports `CodeLibraryStore`
...
- order 1195: `AgentHTTPServer` (class), lines 129747-129786, exports `AgentHTTPServer`
- order 1198: `Handler` (class), lines 130973-132888, exports `Handler`
- order 1201: `SkillsReviewHandler` (class), lines 133690-133803, exports `SkillsReviewHandler`
- order 1205: `CollaborationHandler` (class), lines 135861-136331, exports `CollaborationHandler`

### `server/rag_admin.py`

- order 1200: `_RagAdminAuthMixin` (class), lines 133532-133689, exports `_RagAdminAuthMixin`
- order 1202: `RagAdminHandler` (class), lines 133804-134004, exports `RagAdminHandler`
- order 1203: `CodeAdminHandler` (class), lines 134005-134203, exports `CodeAdminHandler`

### `server/skills.py`

- order 1199: `SkillsHandler` (class), lines 132889-133531, exports `SkillsHandler`

### `session/manager.py`

- order 728: `SessionCreationLimitExceeded` (class), lines 7607-7612, exports `SessionCreationLimitExceeded`
- order 1081: `SessionManager` (class), lines 90762-93266, exports `SessionManager`

### `session/state.py`

- order 1080: `SessionState` (class), lines 30013-90761, exports `SessionState`
...
- order 1183: `SkillsStudioError` (class), lines 116960-116969, exports `SkillsStudioError`
- order 1184: `_studio_slug` (function), lines 116970-116985, exports `_studio_slug`
- order 1185: `_studio_hash` (function), lines 116986-116989, exports `_studio_hash`
- order 1186: `_studio_cookie_value` (function), lines 116990-116999, exports `_studio_cookie_value`
- order 1187: `SkillsStudioStore` (class), lines 117000-118857, exports `SkillsStudioStore`
...
- order 1207: `sqlite_failure_diagnostics` (function), lines 136550-136634, exports `sqlite_failure_diagnostics`
...
- order 1090: `ADMIN_INDEX_HTML` (constant), lines 99309-99616, exports `ADMIN_INDEX_HTML`
- order 1091: `ADMIN_CSS` (constant), lines 99617-99777, exports `ADMIN_CSS`
- order 1092: `ADMIN_JS` (constant), lines 99778-100191, exports `ADMIN_JS`

### `web/assets.py`

- order 1082: `INDEX_HTML` (constant), lines 93267-93528, exports `INDEX_HTML`
- order 1083: `APP_CSS` (constant), lines 93529-94069, exports `APP_CSS`
- order 1084: `APP_JS` (constant), lines 94070-98845, exports `APP_JS`
- order 1085: `APP_CSS` (constant), lines 98846-98866, exports `APP_CSS`
- order 1086: `APP_TS` (constant), lines 98867-98906, exports `APP_TS`

### `web/skills_assets.py`

- order 1087: `SKILLS_INDEX_HTML` (constant), lines 98907-99062, exports `SKILLS_INDEX_HTML`
- order 1088: `SKILLS_EXTRA_CSS` (constant), lines 99063-99162, exports `SKILLS_EXTRA_CSS`
- order 1089: `SKILLS_APP_JS` (constant), lines 99163-99308, exports `SKILLS_APP_JS`
