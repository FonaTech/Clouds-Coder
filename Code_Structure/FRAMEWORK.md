...
- Symbols:
  - `main` (function, lines 43998-44846)
  - `_main_guard_44848` (main_guard, lines 44848-44849)
...
- Symbols:
  - `AppContext` (class, lines 40498-42807)
...
- Symbols:
  ...
  - `PLAN_MODE_RESEARCH_TOOL_ALLOWLIST` (constant, lines 483-487)
  - `FAILURE_LEDGER_MAX_FIXES` (constant, lines 488-488)
  - `FAILURE_LEDGER_MAX_COMPILE_ERRORS` (constant, lines 489-489)
  - `FAILURE_LEDGER_MAX_DELEGATIONS` (constant, lines 490-490)
  - `FAILURE_LEDGER_MAX_STALLS` (constant, lines 491-491)
  - `FAILURE_LEDGER_MAX_TOOL_FPS` (constant, lines 492-492)
  - `FAILURE_LEDGER_MAX_ERRORS` (constant, lines 493-493)
  - `ERROR_CATEGORY_DEFS` (constant, lines 496-533)
  - `CHECKPOINT_MAX_COUNT` (constant, lines 534-534)
  - `CHECKPOINT_INTERVAL_ROUNDS` (constant, lines 535-535)
  - `PERSISTED_ROUTES_MAX` (constant, lines 536-536)
  - `HTML_FRONTEND_REQUEST_KEYWORDS` (constant, lines 537-576)
  - `DEEP_RESEARCH_REQUEST_KEYWORDS` (constant, lines 577-599)
  - `DEEP_RESEARCH_RETRIEVAL_KEYWORDS` (constant, lines 600-619)
  - `DEEP_RESEARCH_TEXT_ONLY_HINT_KEYWORDS` (constant, lines 620-637)
  - `DANGEROUS_PATTERNS` (constant, lines 639-639)
  - `VALID_MSG_TYPES` (constant, lines 640-646)
  - `SUPPORTED_UI_LANGUAGES` (constant, lines 648-653)
  - `UI_LANGUAGE_LABELS` (constant, lines 654-654)
  - `DEFAULT_UI_LANGUAGE` (constant, lines 655-655)
  - `UI_STYLE_CHOICES` (constant, lines 656-656)
  - `UI_STYLE_LABELS` (constant, lines 657-657)
  - `DEFAULT_UI_STYLE` (constant, lines 658-658)
  - `DEFAULT_WEB_UI_DIR` (constant, lines 659-659)
  - `DEFAULT_WEB_UI_CONFIG` (constant, lines 660-660)
  - `WEB_UI_REQUIRED_FILES` (constant, lines 661-668)
  - `WEB_UI_OPTIONAL_FILES` (constant, lines 669-669)
  - `IMAGE_EXTS` (constant, lines 671-684)
  - `IMAGE_FORMATS_NEED_CONVERSION` (constant, lines 685-685)
  - `IMAGE_SAFE_FORMATS` (constant, lines 686-686)
  - `AUDIO_EXTS` (constant, lines 687-697)
  - `VIDEO_EXTS` (constant, lines 698-708)
  - `CODE_PREVIEW_STAGE_MAX_BYTES` (constant, lines 709-709)
  - `CODE_PREVIEW_STAGE_MAX_ROWS` (constant, lines 710-710)
  - `CODE_PREVIEW_STAGE_MAX_PER_FILE` (constant, lines 711-711)
  - `CODE_PREVIEW_STAGE_MAX_TOTAL` (constant, lines 712-712)
  - `RENDER_FRAME_MAX_B64_CHARS` (constant, lines 713-713)
  - `RENDER_FRAME_MAX_POINTS` (constant, lines 714-714)
  - `RENDER_FRAME_MAX_LINES` (constant, lines 715-715)
  - `RENDER_FRAME_MAX_LINE_POINTS` (constant, lines 716-716)
  - `RENDER_FRAME_ACTIVITY_INTERVAL_SECONDS` (constant, lines 717-717)
  - `RAW_TOOLCALL_TEXT_FILTER_THRESHOLD` (constant, lines 718-718)
  - `ASSISTANT_TEXT_PERSIST_MAX_CHARS` (constant, lines 719-719)
  - `ASSISTANT_MESSAGE_EVENT_MAX_CHARS` (constant, lines 720-720)
  - `CODE_PREVIEW_EXTS` (constant, lines 721-810)
  - `CODE_PREVIEW_FILENAMES` (constant, lines 811-822)
  - `MEDIA_CAPABILITY_KEYS` (constant, lines 823-830)
  - `SAMPLE_IMAGE_PNG_B64` (constant, lines 831-834)
  - `SAMPLE_AUDIO_WAV_B64` (constant, lines 835-837)
  - `SAMPLE_VIDEO_MP4_B64` (constant, lines 838-840)
  ...
  - `INDEX_HTML` (constant, lines 29933-30114)
  - `APP_CSS` (constant, lines 30116-30474)
  - `APP_JS` (constant, lines 30476-33285)
  - `APP_TS` (constant, lines 33287-33314)
  - `SKILLS_INDEX_HTML` (constant, lines 33316-33470)
  - `SKILLS_EXTRA_CSS` (constant, lines 33472-33567)
  - `SKILLS_APP_JS` (constant, lines 33569-33661)
  - `RAG_TERM_GROUPS` (constant, lines 33663-33673)
  - `RAG_RESEARCH_HINTS` (constant, lines 33674-33695)
  - `RAG_CODE_HINTS` (constant, lines 33696-33706)
  - `RAG_SHORT_TOKEN_ALLOWLIST` (constant, lines 33707-33722)
  - `RAG_EN_STOPWORDS` (constant, lines 33723-33795)
  - `RAG_ZH_STOPWORDS` (constant, lines 33796-33832)
  - `RAG_GENERIC_ENTITY_TERMS_EN` (constant, lines 33833-33911)
  - `RAG_GENERIC_ENTITY_TERMS_ZH` (constant, lines 33912-33954)
  - `RAG_STRUCTURAL_ENTITY_PATTERNS` (constant, lines 33955-33973)
  - `CODE_LIBRARY_IGNORED_DIRS` (constant, lines 34296-34301)
  - `CODE_LIBRARY_LANGUAGE_BY_EXT` (constant, lines 34302-34358)
  - `CODE_LIBRARY_SPECIAL_FILENAMES` (constant, lines 34359-34365)
  - `RAG_ADMIN_INDEX_HTML` (constant, lines 38972-39129)
  - `RAG_ADMIN_CSS` (constant, lines 39131-39221)
  - `RAG_ADMIN_JS` (constant, lines 39223-40449)
  - `CODE_ADMIN_INDEX_HTML` (constant, lines 40451-40460)
  - `CODE_ADMIN_CSS` (constant, lines 40461-40491)
  - `CODE_ADMIN_JS` (constant, lines 40492-40496)
...
- Symbols:
  - `normalize_ui_language` (function, lines 1186-1208)
  - `normalize_ui_style` (function, lines 1211-1228)
...
- Symbols:
  - `_code_module_name` (function, lines 34392-34406)
  - `_code_choose_community` (function, lines 34409-34416)
  - `_code_query_terms` (function, lines 34419-34431)
  - `TFGraphIDFIndex` (class, lines 35407-36765)
  - `CodeGraphIndex` (class, lines 38205-38617)
...
- Symbols:
  - `_rag_parse_file_worker` (function, lines 37318-37332)
  - `RAGIngestionService` (class, lines 37335-38202)
  - `CodeIngestionService` (class, lines 38886-38970)
...
- Symbols:
  ...
  - `_rag_safe_name` (function, lines 33976-33979)
  - `_rag_detect_language` (function, lines 33982-33996)
  - `_rag_cjk_ngrams` (function, lines 33999-34011)
  - `_rag_is_noise_token` (function, lines 34014-34033)
  - `_rag_entity_allowed` (function, lines 34036-34048)
  - `_rag_filter_entities` (function, lines 34051-34065)
  - `_rag_filename_entity_aliases` (function, lines 34068-34101)
  - `_rag_apply_filename_entity_policy` (function, lines 34104-34134)
  - `_rag_choose_community` (function, lines 34137-34154)
  - `_rag_tokenize` (function, lines 34157-34187)
  - `_rag_expand_tokens` (function, lines 34190-34204)
  - `_rag_extract_entities` (function, lines 34207-34223)
  - `_rag_classify_document` (function, lines 34226-34260)
  - `_rag_chunk_text` (function, lines 34263-34293)
  - `_code_language_from_name` (function, lines 34368-34384)
  - `_code_is_test_path` (function, lines 34387-34389)
  - `CodeContentParser` (class, lines 34434-34894)
  - `RAGContentParser` (class, lines 34897-35404)
...
- Symbols:
  - `RAGLibraryStore` (class, lines 36768-37315)
  - `CodeLibraryStore` (class, lines 38620-38883)
...
- Symbols:
  - `AgentHTTPServer` (class, lines 42809-42837)
  - `Handler` (class, lines 42839-43488)
  - `SkillsHandler` (class, lines 43490-43683)
  - `RagAdminHandler` (class, lines 43685-43839)
  - `CodeAdminHandler` (class, lines 43842-43996)
...
- Symbols:
  - `SessionManager` (class, lines 29084-29931)
...
- Symbols:
  - `SessionState` (class, lines 9720-29082)
