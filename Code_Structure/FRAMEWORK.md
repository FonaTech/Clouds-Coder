...
- Symbols:
  - `main` (function, lines 70605-71711)
  - `_main_guard_71713` (main_guard, lines 71713-71714)
...
- Symbols:
  - `AppContext` (class, lines 65641-69066)
...
- Symbols:
  ...
  - `INDEX_HTML` (constant, lines 47392-47581)
  - `APP_CSS` (constant, lines 47583-48000)
  - `APP_JS` (constant, lines 48002-51506)
  - `APP_TS` (constant, lines 51508-51535)
  - `SKILLS_INDEX_HTML` (constant, lines 51537-51691)
  - `SKILLS_EXTRA_CSS` (constant, lines 51693-51788)
  - `SKILLS_APP_JS` (constant, lines 51790-51931)
  - `RAG_TERM_GROUPS` (constant, lines 51933-56565)
  - `RAG_RESEARCH_HINTS` (constant, lines 56566-56587)
  - `RAG_CODE_HINTS` (constant, lines 56588-56598)
  - `RAG_SHORT_TOKEN_ALLOWLIST` (constant, lines 56599-56614)
  - `RAG_EN_STOPWORDS` (constant, lines 56615-56687)
  - `RAG_ZH_STOPWORDS` (constant, lines 56688-56724)
  - `RAG_GENERIC_ENTITY_TERMS_EN` (constant, lines 56725-56803)
  - `RAG_GENERIC_ENTITY_TERMS_ZH` (constant, lines 56804-56846)
  - `RAG_STRUCTURAL_ENTITY_PATTERNS` (constant, lines 56847-56865)
  - `CODE_LIBRARY_IGNORED_DIRS` (constant, lines 57558-57563)
  - `CODE_LIBRARY_LANGUAGE_BY_EXT` (constant, lines 57564-57620)
  - `CODE_LIBRARY_SPECIAL_FILENAMES` (constant, lines 57621-57627)
  - `RAG_ADMIN_INDEX_HTML` (constant, lines 63551-63724)
  - `RAG_ADMIN_CSS` (constant, lines 63726-63816)
  - `RAG_ADMIN_JS` (constant, lines 63818-65581)
  - `CODE_ADMIN_INDEX_HTML` (constant, lines 65583-65594)
  - `CODE_ADMIN_CSS` (constant, lines 65595-65625)
  - `CODE_ADMIN_JS` (constant, lines 65626-65630)
...
- Symbols:
  - `_code_module_name` (function, lines 57654-57668)
  - `_code_choose_community` (function, lines 57671-57678)
  - `_code_query_terms` (function, lines 57681-57693)
  - `TFGraphIDFIndex` (class, lines 58746-60312)
  - `CodeGraphIndex` (class, lines 62730-63195)
...
- Symbols:
  - `_rag_trigram_set` (function, lines 57078-57083)
  - `_rag_jaccard_sim` (function, lines 57086-57093)
  - `_rag_mmr_select` (function, lines 57096-57143)
  - `_rag_embed_text` (function, lines 57280-57301)
  - `_rag_embed_batch` (function, lines 57304-57310)
  - `_rag_window_for_query` (function, lines 57313-57325)
  - `_rag_focused_excerpt` (function, lines 57328-57368)
  - `_rag_query_variants` (function, lines 57371-57408)
  - `_rag_parse_segments` (function, lines 57411-57471)
  - `_rag_parse_file_worker` (function, lines 61834-61848)
  - `RAGIngestionService` (class, lines 61851-62727)
  - `CodeIngestionService` (class, lines 63464-63549)
...
- Symbols:
  ...
  - `_rag_safe_name` (function, lines 56877-56880)
  - `_rag_detect_language` (function, lines 56883-56897)
  - `_rag_cjk_ngrams` (function, lines 56900-56912)
  - `_rag_is_noise_token` (function, lines 56915-56934)
  - `_rag_entity_allowed` (function, lines 56937-56949)
  - `_rag_filter_entities` (function, lines 56952-56966)
  - `_rag_filename_entity_aliases` (function, lines 56969-57002)
  - `_rag_apply_filename_entity_policy` (function, lines 57005-57035)
  - `_rag_choose_community` (function, lines 57038-57075)
  - `_rag_tokenize` (function, lines 57146-57197)
  - `_rag_expand_tokens` (function, lines 57200-57221)
  - `_rag_extract_entities` (function, lines 57224-57240)
  - `_rag_classify_document` (function, lines 57243-57277)
  - `_rag_chunk_text` (function, lines 57474-57553)
  - `_code_language_from_name` (function, lines 57630-57646)
  - `_code_is_test_path` (function, lines 57649-57651)
  - `_CallCollector` (class, lines 57696-57708)
  - `_ALGO_COMPLEXITY_RE` (assignment, lines 57711-57711)
  - `_ALGO_STEP_RE` (assignment, lines 57712-57712)
  - `_ALGO_MATH_VARS` (assignment, lines 57713-57713)
  - `_ALGO_DOC_KEYWORDS` (assignment, lines 57714-57714)
  - `_detect_algo_chunk` (function, lines 57717-57740)
  - `CodeContentParser` (class, lines 57743-58233)
  - `RAGContentParser` (class, lines 58236-58743)
...
- Symbols:
  - `RAGLibraryStore` (class, lines 60324-60898)
  - `WikiStore` (class, lines 60901-61430)
  - `WorkflowMemoryStore` (class, lines 61433-61831)
  - `CodeLibraryStore` (class, lines 63198-63461)
...
- Symbols:
  - `AgentHTTPServer` (class, lines 69077-69105)
  - `Handler` (class, lines 69109-70028)
  - `SkillsHandler` (class, lines 70030-70235)
  - `RagAdminHandler` (class, lines 70237-70405)
  - `CodeAdminHandler` (class, lines 70408-70594)
...
- Symbols:
  ...
  - `SessionManager` (class, lines 46256-47390)
...
- Symbols:
  - `SessionState` (class, lines 14118-46254)
