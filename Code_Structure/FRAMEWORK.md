...
- Symbols:
  - `main` (function, lines 54748-55729)
  - `_main_guard_55731` (main_guard, lines 55731-55732)
...
- Symbols:
  - `AppContext` (class, lines 50911-53344)
...
- Symbols:
  ...
  - `INDEX_HTML` (constant, lines 39968-40155)
  - `APP_CSS` (constant, lines 40157-40545)
  - `APP_JS` (constant, lines 40547-43649)
  - `APP_TS` (constant, lines 43651-43678)
  - `SKILLS_INDEX_HTML` (constant, lines 43680-43834)
  - `SKILLS_EXTRA_CSS` (constant, lines 43836-43931)
  - `SKILLS_APP_JS` (constant, lines 43933-44074)
  - `RAG_TERM_GROUPS` (constant, lines 44076-44086)
  - `RAG_RESEARCH_HINTS` (constant, lines 44087-44108)
  - `RAG_CODE_HINTS` (constant, lines 44109-44119)
  - `RAG_SHORT_TOKEN_ALLOWLIST` (constant, lines 44120-44135)
  - `RAG_EN_STOPWORDS` (constant, lines 44136-44208)
  - `RAG_ZH_STOPWORDS` (constant, lines 44209-44245)
  - `RAG_GENERIC_ENTITY_TERMS_EN` (constant, lines 44246-44324)
  - `RAG_GENERIC_ENTITY_TERMS_ZH` (constant, lines 44325-44367)
  - `RAG_STRUCTURAL_ENTITY_PATTERNS` (constant, lines 44368-44386)
  - `CODE_LIBRARY_IGNORED_DIRS` (constant, lines 44709-44714)
  - `CODE_LIBRARY_LANGUAGE_BY_EXT` (constant, lines 44715-44771)
  - `CODE_LIBRARY_SPECIAL_FILENAMES` (constant, lines 44772-44778)
  - `RAG_ADMIN_INDEX_HTML` (constant, lines 49385-49542)
  - `RAG_ADMIN_CSS` (constant, lines 49544-49634)
  - `RAG_ADMIN_JS` (constant, lines 49636-50862)
  - `CODE_ADMIN_INDEX_HTML` (constant, lines 50864-50873)
  - `CODE_ADMIN_CSS` (constant, lines 50874-50904)
  - `CODE_ADMIN_JS` (constant, lines 50905-50909)
...
- Symbols:
  - `_code_module_name` (function, lines 44805-44819)
  - `_code_choose_community` (function, lines 44822-44829)
  - `_code_query_terms` (function, lines 44832-44844)
  - `TFGraphIDFIndex` (class, lines 45820-47178)
  - `CodeGraphIndex` (class, lines 48618-49030)
...
- Symbols:
  - `_rag_parse_file_worker` (function, lines 47731-47745)
  - `RAGIngestionService` (class, lines 47748-48615)
  - `CodeIngestionService` (class, lines 49299-49383)
...
- Symbols:
  ...
  - `_rag_safe_name` (function, lines 44389-44392)
  - `_rag_detect_language` (function, lines 44395-44409)
  - `_rag_cjk_ngrams` (function, lines 44412-44424)
  - `_rag_is_noise_token` (function, lines 44427-44446)
  - `_rag_entity_allowed` (function, lines 44449-44461)
  - `_rag_filter_entities` (function, lines 44464-44478)
  - `_rag_filename_entity_aliases` (function, lines 44481-44514)
  - `_rag_apply_filename_entity_policy` (function, lines 44517-44547)
  - `_rag_choose_community` (function, lines 44550-44567)
  - `_rag_tokenize` (function, lines 44570-44600)
  - `_rag_expand_tokens` (function, lines 44603-44617)
  - `_rag_extract_entities` (function, lines 44620-44636)
  - `_rag_classify_document` (function, lines 44639-44673)
  - `_rag_chunk_text` (function, lines 44676-44706)
  - `_code_language_from_name` (function, lines 44781-44797)
  - `_code_is_test_path` (function, lines 44800-44802)
  - `CodeContentParser` (class, lines 44847-45307)
  - `RAGContentParser` (class, lines 45310-45817)
...
- Symbols:
  - `RAGLibraryStore` (class, lines 47181-47728)
  - `CodeLibraryStore` (class, lines 49033-49296)
...
- Symbols:
  - `AgentHTTPServer` (class, lines 53346-53374)
  - `Handler` (class, lines 53376-54235)
  - `SkillsHandler` (class, lines 54237-54433)
  - `RagAdminHandler` (class, lines 54435-54589)
  - `CodeAdminHandler` (class, lines 54592-54746)
...
- Symbols:
  ...
  - `SessionManager` (class, lines 39079-39966)
...
- Symbols:
  - `SessionState` (class, lines 13115-39077)
