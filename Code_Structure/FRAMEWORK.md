...
- Symbols:
  - `main` (function, lines 50786-51636)
  - `_main_guard_51638` (main_guard, lines 51638-51639)
...
- Symbols:
  - `AppContext` (class, lines 47121-49443)
...
- Symbols:
  ...
  - `INDEX_HTML` (constant, lines 36311-36498)
  - `APP_CSS` (constant, lines 36500-36878)
  - `APP_JS` (constant, lines 36880-39859)
  - `APP_TS` (constant, lines 39861-39888)
  - `SKILLS_INDEX_HTML` (constant, lines 39890-40044)
  - `SKILLS_EXTRA_CSS` (constant, lines 40046-40141)
  - `SKILLS_APP_JS` (constant, lines 40143-40284)
  - `RAG_TERM_GROUPS` (constant, lines 40286-40296)
  - `RAG_RESEARCH_HINTS` (constant, lines 40297-40318)
  - `RAG_CODE_HINTS` (constant, lines 40319-40329)
  - `RAG_SHORT_TOKEN_ALLOWLIST` (constant, lines 40330-40345)
  - `RAG_EN_STOPWORDS` (constant, lines 40346-40418)
  - `RAG_ZH_STOPWORDS` (constant, lines 40419-40455)
  - `RAG_GENERIC_ENTITY_TERMS_EN` (constant, lines 40456-40534)
  - `RAG_GENERIC_ENTITY_TERMS_ZH` (constant, lines 40535-40577)
  - `RAG_STRUCTURAL_ENTITY_PATTERNS` (constant, lines 40578-40596)
  - `CODE_LIBRARY_IGNORED_DIRS` (constant, lines 40919-40924)
  - `CODE_LIBRARY_LANGUAGE_BY_EXT` (constant, lines 40925-40981)
  - `CODE_LIBRARY_SPECIAL_FILENAMES` (constant, lines 40982-40988)
  - `RAG_ADMIN_INDEX_HTML` (constant, lines 45595-45752)
  - `RAG_ADMIN_CSS` (constant, lines 45754-45844)
  - `RAG_ADMIN_JS` (constant, lines 45846-47072)
  - `CODE_ADMIN_INDEX_HTML` (constant, lines 47074-47083)
  - `CODE_ADMIN_CSS` (constant, lines 47084-47114)
  - `CODE_ADMIN_JS` (constant, lines 47115-47119)
...
- Symbols:
  - `_code_module_name` (function, lines 41015-41029)
  - `_code_choose_community` (function, lines 41032-41039)
  - `_code_query_terms` (function, lines 41042-41054)
  - `TFGraphIDFIndex` (class, lines 42030-43388)
  - `CodeGraphIndex` (class, lines 44828-45240)
...
- Symbols:
  - `_rag_parse_file_worker` (function, lines 43941-43955)
  - `RAGIngestionService` (class, lines 43958-44825)
  - `CodeIngestionService` (class, lines 45509-45593)
...
- Symbols:
  ...
  - `_rag_safe_name` (function, lines 40599-40602)
  - `_rag_detect_language` (function, lines 40605-40619)
  - `_rag_cjk_ngrams` (function, lines 40622-40634)
  - `_rag_is_noise_token` (function, lines 40637-40656)
  - `_rag_entity_allowed` (function, lines 40659-40671)
  - `_rag_filter_entities` (function, lines 40674-40688)
  - `_rag_filename_entity_aliases` (function, lines 40691-40724)
  - `_rag_apply_filename_entity_policy` (function, lines 40727-40757)
  - `_rag_choose_community` (function, lines 40760-40777)
  - `_rag_tokenize` (function, lines 40780-40810)
  - `_rag_expand_tokens` (function, lines 40813-40827)
  - `_rag_extract_entities` (function, lines 40830-40846)
  - `_rag_classify_document` (function, lines 40849-40883)
  - `_rag_chunk_text` (function, lines 40886-40916)
  - `_code_language_from_name` (function, lines 40991-41007)
  - `_code_is_test_path` (function, lines 41010-41012)
  - `CodeContentParser` (class, lines 41057-41517)
  - `RAGContentParser` (class, lines 41520-42027)
...
- Symbols:
  - `RAGLibraryStore` (class, lines 43391-43938)
  - `CodeLibraryStore` (class, lines 45243-45506)
...
- Symbols:
  - `AgentHTTPServer` (class, lines 49445-49473)
  - `Handler` (class, lines 49475-50274)
  - `SkillsHandler` (class, lines 50276-50471)
  - `RagAdminHandler` (class, lines 50473-50627)
  - `CodeAdminHandler` (class, lines 50630-50784)
...
- Symbols:
  - `SessionManager` (class, lines 35437-36309)
...
- Symbols:
  - `SessionState` (class, lines 12103-35435)
