...
- Symbols:
  - `main` (function, lines 52969-53902)
  - `_main_guard_53904` (main_guard, lines 53904-53905)
...
- Symbols:
  - `BackgroundManager` (class, lines 10993-11073)
...
- Symbols:
  - `MessageBus` (class, lines 11075-11129)
...
- Symbols:
  - `TaskManager` (class, lines 10865-10991)
...
- Symbols:
  - `TodoManager` (class, lines 5180-5430)
...
- Symbols:
  - `WorktreeManager` (class, lines 11131-11342)
...
- Symbols:
  - `AppContext` (class, lines 49169-51585)
...
- Symbols:
  ...
  - `EMBEDDED_SKILLS_ARCHIVE_B64` (constant, lines 5432-5951)
  - `EMBEDDED_SKILLS_ARCHIVE_SHA256` (constant, lines 5952-5952)
  - `EMBEDDED_SKILLS_ARCHIVE_FILES` (constant, lines 5953-5976)
  - `BUILTIN_CLAWHUB_SKILLS_VERSION` (constant, lines 9134-9134)
  - `EMBEDDED_CLAWHUB_SKILLS_ARCHIVE_B64` (constant, lines 9136-9380)
  - `SKILL_PROTOCOL_LOCAL` (constant, lines 9439-9439)
  - `SKILL_PROTOCOL_CLAWHUB` (constant, lines 9440-9440)
  - `SKILL_PROTOCOL_HTTP_JSON` (constant, lines 9441-9441)
  - `SKILL_PROTOCOL_SPECS` (constant, lines 9443-9474)
  - `AGENT_TOOL_ALLOWLIST` (constant, lines 12639-12682)
  - `INDEX_HTML` (constant, lines 38226-38413)
  - `APP_CSS` (constant, lines 38415-38803)
  - `APP_JS` (constant, lines 38805-41907)
  - `APP_TS` (constant, lines 41909-41936)
  - `SKILLS_INDEX_HTML` (constant, lines 41938-42092)
  - `SKILLS_EXTRA_CSS` (constant, lines 42094-42189)
  - `SKILLS_APP_JS` (constant, lines 42191-42332)
  - `RAG_TERM_GROUPS` (constant, lines 42334-42344)
  - `RAG_RESEARCH_HINTS` (constant, lines 42345-42366)
  - `RAG_CODE_HINTS` (constant, lines 42367-42377)
  - `RAG_SHORT_TOKEN_ALLOWLIST` (constant, lines 42378-42393)
  - `RAG_EN_STOPWORDS` (constant, lines 42394-42466)
  - `RAG_ZH_STOPWORDS` (constant, lines 42467-42503)
  - `RAG_GENERIC_ENTITY_TERMS_EN` (constant, lines 42504-42582)
  - `RAG_GENERIC_ENTITY_TERMS_ZH` (constant, lines 42583-42625)
  - `RAG_STRUCTURAL_ENTITY_PATTERNS` (constant, lines 42626-42644)
  - `CODE_LIBRARY_IGNORED_DIRS` (constant, lines 42967-42972)
  - `CODE_LIBRARY_LANGUAGE_BY_EXT` (constant, lines 42973-43029)
  - `CODE_LIBRARY_SPECIAL_FILENAMES` (constant, lines 43030-43036)
  - `RAG_ADMIN_INDEX_HTML` (constant, lines 47643-47800)
  - `RAG_ADMIN_CSS` (constant, lines 47802-47892)
  - `RAG_ADMIN_JS` (constant, lines 47894-49120)
  - `CODE_ADMIN_INDEX_HTML` (constant, lines 49122-49131)
  - `CODE_ADMIN_CSS` (constant, lines 49132-49162)
  - `CODE_ADMIN_JS` (constant, lines 49163-49167)
...
- Symbols:
  - `OllamaError` (class, lines 11344-11347)
  - `OllamaClient` (class, lines 11349-12401)
...
- Symbols:
  - `_code_module_name` (function, lines 43063-43077)
  - `_code_choose_community` (function, lines 43080-43087)
  - `_code_query_terms` (function, lines 43090-43102)
  - `TFGraphIDFIndex` (class, lines 44078-45436)
  - `CodeGraphIndex` (class, lines 46876-47288)
...
- Symbols:
  - `_rag_parse_file_worker` (function, lines 45989-46003)
  - `RAGIngestionService` (class, lines 46006-46873)
  - `CodeIngestionService` (class, lines 47557-47641)
...
- Symbols:
  ...
  - `_rag_safe_name` (function, lines 42647-42650)
  - `_rag_detect_language` (function, lines 42653-42667)
  - `_rag_cjk_ngrams` (function, lines 42670-42682)
  - `_rag_is_noise_token` (function, lines 42685-42704)
  - `_rag_entity_allowed` (function, lines 42707-42719)
  - `_rag_filter_entities` (function, lines 42722-42736)
  - `_rag_filename_entity_aliases` (function, lines 42739-42772)
  - `_rag_apply_filename_entity_policy` (function, lines 42775-42805)
  - `_rag_choose_community` (function, lines 42808-42825)
  - `_rag_tokenize` (function, lines 42828-42858)
  - `_rag_expand_tokens` (function, lines 42861-42875)
  - `_rag_extract_entities` (function, lines 42878-42894)
  - `_rag_classify_document` (function, lines 42897-42931)
  - `_rag_chunk_text` (function, lines 42934-42964)
  - `_code_language_from_name` (function, lines 43039-43055)
  - `_code_is_test_path` (function, lines 43058-43060)
  - `CodeContentParser` (class, lines 43105-43565)
  - `RAGContentParser` (class, lines 43568-44075)
...
- Symbols:
  - `RAGLibraryStore` (class, lines 45439-45986)
  - `CodeLibraryStore` (class, lines 47291-47554)
...
- Symbols:
  - `AgentHTTPServer` (class, lines 51587-51615)
  - `Handler` (class, lines 51617-52457)
  - `SkillsHandler` (class, lines 52459-52654)
  - `RagAdminHandler` (class, lines 52656-52810)
  - `CodeAdminHandler` (class, lines 52813-52967)
...
- Symbols:
  ...
  - `SessionManager` (class, lines 37352-38224)
...
- Symbols:
  - `SessionState` (class, lines 12684-37350)
...
- Symbols:
  - `ensure_embedded_skills_at_root` (function, lines 5979-6031)
  - `ensure_embedded_skills` (function, lines 6034-6035)
  - `detect_upload_parser_capabilities` (function, lines 6043-6058)
  - `_render_cap_markdown` (function, lines 6060-6074)
  - `_write_text_if_changed` (function, lines 6076-6081)
  - `ensure_generated_document_skills` (function, lines 6083-6171)
  - `ensure_generated_image_coding_feedback_skill` (function, lines 6173-6272)
  - `_skill_knowledge_files` (function, lines 6274-6293)
  - `analyze_skill_building_knowledge` (function, lines 6295-6349)
  - `_sanitize_skill_slug` (function, lines 6351-6353)
  - `_build_skills_gen_skill_content` (function, lines 6355-6386)
  - `ensure_generated_skills_gen_skill` (function, lines 6388-6392)
  - `ensure_generated_execution_recovery_skill` (function, lines 6394-6472)
  - `ensure_generated_systematic_debugging_skill` (function, lines 6474-6746)
  - `ensure_generated_code_engineering_mastery_skill` (function, lines 6748-6866)
  - `ensure_generated_smart_file_navigation_skill` (function, lines 6868-6986)
  - `ensure_generated_html_frontend_report_skills` (function, lines 6988-7193)
  - `ensure_generated_deep_research_skills` (function, lines 7195-7463)
  - `ensure_generated_research_scientific_skills` (function, lines 7465-8101)
  - `ensure_generated_rag_mastery_skills` (function, lines 8107-8403)
  - `ensure_generated_multimodal_comprehension_skills` (function, lines 8409-9098)
  - `ensure_generated_runtime_skills_manifest` (function, lines 9101-9132)
  - `ensure_embedded_clawhub_skills` (function, lines 9383-9420)
  - `ensure_runtime_skills` (function, lines 9422-9437)
  - `_BUILTIN_SKILLS` (assignment, lines 9479-9567)
  - `SkillStore` (class, lines 9569-10863)
...
- Symbols:
  ...
  - `tool_def` (function, lines 12403-12415)
  - `TOOLS` (constant, lines 12417-12593)
  - `TOOL_REQUIRED_ARGS` (constant, lines 12595-12595)
  - `TOOL_SPEC_BY_NAME` (constant, lines 12596-12596)
  - `TOOL_NAME_FUZZY_MAP` (constant, lines 12608-12608)
  - `canonicalize_tool_name` (function, lines 12626-12637)
...
- Symbols:
  ...
  - `_module_exists` (function, lines 6037-6041)
