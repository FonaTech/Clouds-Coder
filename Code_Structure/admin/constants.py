...
# split-source: order=123 original-lines=3787-3787 hash=ba75d7debc8faf30
ADMIN_STATE_DIRNAME = ".clouds_coder_admin"

# split-source: order=124 original-lines=3788-3788 hash=a7fc266725f53e4c
ADMIN_CONFIG_FILENAME = "startup_config.json"

# split-source: order=125 original-lines=3789-3789 hash=de32f15d9bd5d6fc
ADMIN_APPS_FILENAME = "shared_apps.json"

# split-source: order=126 original-lines=3790-3790 hash=43a96d0e5164b2d4
ADMIN_TELEMETRY_FILENAME = "telemetry.sqlite"

# split-source: order=127 original-lines=3791-3791 hash=df177de1f99d6676
ADMIN_AUTH_FILENAME = "auth.sqlite"

# split-source: order=137 original-lines=3838-3838 hash=def27da409b9ad7d
ADMIN_MAX_APP_SKILLS = 8

# split-source: order=138 original-lines=3839-3839 hash=de3edd9e47c1fd02
ADMIN_MAX_APP_CAPSULE_CHARS = 12_000

# split-source: order=139 original-lines=3840-3840 hash=e166449a5f670908
ADMIN_MAX_APP_RESOURCE_FILES = 128

# split-source: order=140 original-lines=3841-3841 hash=3c0c67698e4d1dd4
ADMIN_MAX_APP_RESOURCE_BYTES = 64_000_000

# split-source: order=141 original-lines=3842-3842 hash=d7b3d490cabf04c5
ADMIN_APP_INLINE_BLOB_BYTES = 256_000

# split-source: order=142 original-lines=3843-3843 hash=2269cfe84a5c17ac
ADMIN_AUTH_SESSION_TTL_SECONDS = 12 * 60 * 60

# split-source: order=143 original-lines=3844-3844 hash=881b2fd32105454d
ADMIN_AUTH_PASSWORD_ITERATIONS = 600_000

# split-source: order=144 original-lines=3845-3845 hash=525aa27e7d272210
ADMIN_AUTH_MAX_ACTIVE_SESSIONS = 32

# split-source: order=1170 original-lines=117380-117381 hash=7bcb3d1e676e0c51
...
# split-source: order=1171 original-lines=117382-117382 hash=29bbe2e6437d616a
...
# split-source: order=1172 original-lines=117383-117383 hash=a175af8ed0ed550b
