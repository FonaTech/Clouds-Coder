...
# split-source: order=128 original-lines=3920-3920 hash=ba75d7debc8faf30
ADMIN_STATE_DIRNAME = ".clouds_coder_admin"

# split-source: order=129 original-lines=3921-3921 hash=a7fc266725f53e4c
ADMIN_CONFIG_FILENAME = "startup_config.json"

# split-source: order=130 original-lines=3922-3922 hash=de32f15d9bd5d6fc
ADMIN_APPS_FILENAME = "shared_apps.json"

# split-source: order=131 original-lines=3923-3923 hash=43a96d0e5164b2d4
ADMIN_TELEMETRY_FILENAME = "telemetry.sqlite"

# split-source: order=132 original-lines=3924-3924 hash=df177de1f99d6676
ADMIN_AUTH_FILENAME = "auth.sqlite"

# split-source: order=142 original-lines=3971-3971 hash=def27da409b9ad7d
ADMIN_MAX_APP_SKILLS = 8

# split-source: order=143 original-lines=3972-3972 hash=de3edd9e47c1fd02
ADMIN_MAX_APP_CAPSULE_CHARS = 12_000

# split-source: order=144 original-lines=3973-3973 hash=e166449a5f670908
ADMIN_MAX_APP_RESOURCE_FILES = 128

# split-source: order=145 original-lines=3974-3974 hash=3c0c67698e4d1dd4
ADMIN_MAX_APP_RESOURCE_BYTES = 64_000_000

# split-source: order=146 original-lines=3975-3975 hash=d7b3d490cabf04c5
ADMIN_APP_INLINE_BLOB_BYTES = 256_000

# split-source: order=147 original-lines=3976-3976 hash=2269cfe84a5c17ac
ADMIN_AUTH_SESSION_TTL_SECONDS = 12 * 60 * 60

# split-source: order=148 original-lines=3977-3977 hash=881b2fd32105454d
ADMIN_AUTH_PASSWORD_ITERATIONS = 600_000

# split-source: order=149 original-lines=3978-3978 hash=525aa27e7d272210
ADMIN_AUTH_MAX_ACTIVE_SESSIONS = 32

# split-source: order=1191 original-lines=118746-118747 hash=7bcb3d1e676e0c51
...
# split-source: order=1192 original-lines=118748-118748 hash=29bbe2e6437d616a
...
# split-source: order=1193 original-lines=118749-118749 hash=a175af8ed0ed550b
