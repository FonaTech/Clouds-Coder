...
# split-source: order=739 original-lines=9465-9573 hash=1f332fcf893a600c
...
# split-source: order=740 original-lines=9574-9577 hash=40890890ea051821


def _admin_factory_config() -> dict:
    return {row["key"]: row.get("factory_default") for row in _admin_config_schema()}

# split-source: order=741 original-lines=9578-9698 hash=dc8951a1020569f6
...
# split-source: order=742 original-lines=9699-9735 hash=80095834e40509e0
...
# split-source: order=743 original-lines=9736-9751 hash=12dc636b75f461e9
...
# split-source: order=744 original-lines=9752-9838 hash=0c9904b7a02980a4
...
# split-source: order=745 original-lines=9839-9858 hash=131500c48f7797e8
...
# split-source: order=746 original-lines=9859-9878 hash=74581d4419b4cfc5
