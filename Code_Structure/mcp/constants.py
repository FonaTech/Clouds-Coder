...
# split-source: order=174 original-lines=4156-4156 hash=d2766984060631d7
MCP_SERVICE_PORT_OFFSET = 4

# split-source: order=1004 original-lines=23941-23970 hash=637b2ed2c7e80e0c
...
# split-source: order=1005 original-lines=23971-23971 hash=8952944d0fe9c8fd
MCP_NAME_RE = re.compile(r"[^a-zA-Z0-9_-]")

# split-source: order=1006 original-lines=23972-23972 hash=d98dc1d8bc8c35e0
MCP_TOOL_PREFIX = "mcp__"

# split-source: order=1007 original-lines=23973-23973 hash=f05e95f5608e9db3
_MCP_DEFAULT_HANDSHAKE_TIMEOUT = 20.0

# split-source: order=1008 original-lines=23974-23974 hash=2cfd699f97d758a8
_MCP_DEFAULT_CALL_TIMEOUT = 60.0

# split-source: order=1009 original-lines=23975-23975 hash=97320939011d5517
_MCP_MAX_RESULT_CHARS = 24000

# split-source: order=1010 original-lines=23976-23976 hash=d3f40a4f9ffb843b
