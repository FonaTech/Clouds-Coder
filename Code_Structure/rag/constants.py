...
# split-source: order=966 original-lines=90322-94955 hash=3cf5127aba1f993e
...
# split-source: order=967 original-lines=94956-94977 hash=16c96d4b2d9ea8e8
RAG_RESEARCH_HINTS = (
    "abstract",
    "introduction",
    "related work",
...
# split-source: order=968 original-lines=94978-94988 hash=636311fb17640a4e
RAG_CODE_HINTS = (
    "def ",
    "class ",
    "import ",
...
# split-source: order=969 original-lines=94989-95004 hash=4605c77eed589f3f
...
# split-source: order=970 original-lines=95005-95077 hash=527026fadb463036
RAG_EN_STOPWORDS = {
    "a",
    "an",
    "and",
...
# split-source: order=971 original-lines=95078-95114 hash=7523a7a144f1f7c8
RAG_ZH_STOPWORDS = {
    "一个",
    "一种",
    "一些",
...
# split-source: order=972 original-lines=95115-95193 hash=fffc05a6e73ad1f0
...
# split-source: order=973 original-lines=95194-95236 hash=cd605de6a86d441a
...
# split-source: order=974 original-lines=95237-95255 hash=e90fa9ad0c5a4f61
...
# split-source: order=999 original-lines=96000-96009 hash=bca531e8850a5266
...
# split-source: order=1000 original-lines=96010-96066 hash=bc72eba2e2dbde18
...
# split-source: order=1001 original-lines=96067-96073 hash=9de27595b7cb2425
