...
# split-source: order=92 original-lines=167-167 hash=0de182d69186f310
RAG_LIBRARY_DIRNAME = "RAG_Library"

# split-source: order=93 original-lines=168-168 hash=1c1e1de533d243c7
RAG_ADMIN_PORT_OFFSET = 2

# split-source: order=94 original-lines=169-169 hash=c0f0809a695fc9d1
CODE_LIBRARY_DIRNAME = "Code_Library"

# split-source: order=99 original-lines=177-177 hash=15ac97b37116e7af
WEB_SEARCH_INDEX_DIRNAME = "Web_Search_Index"

# split-source: order=101 original-lines=179-179 hash=a03862a542a37ae6
USER_MEMORY_DIRNAME = ".clouds_coder"

# split-source: order=102 original-lines=180-180 hash=f9d6faf310172e3d
USER_MEMORY_DB_FILENAME = "user_memory.sqlite"

# split-source: order=103 original-lines=181-181 hash=febd58a2c34ffb3d
USER_MEMORY_PROFILE_FILENAME = "user_profile.json"

# split-source: order=104 original-lines=182-182 hash=8f0b97463a93304a
USER_MEMORY_MODE_CHOICES = {"off", "weak", "on"}

# split-source: order=106 original-lines=184-184 hash=72466feef8186fb8
USER_MEMORY_WEAK_CAPSULE_CHARS = 1200

# split-source: order=107 original-lines=185-185 hash=5512298c89436343
USER_MEMORY_ON_CAPSULE_CHARS = 2200

# split-source: order=108 original-lines=186-189 hash=acd37ce36c51b613
...
# split-source: order=109 original-lines=190-190 hash=c5722113df436b0f
USER_MEMORY_MAX_SUMMARY_CHARS = 1200

# split-source: order=110 original-lines=191-191 hash=b23bc08397e51a50
USER_MEMORY_QUERY_LIMIT = 8

# split-source: order=111 original-lines=192-192 hash=42789d8e57098529
USER_MEMORY_DECAY_HALFLIFE_DAYS = 45.0

# split-source: order=112 original-lines=193-193 hash=25a72ca204adb0bf
USER_MEMORY_PROFILE_SCHEMA_VERSION = 1

# split-source: order=123 original-lines=204-204 hash=05e40a7a15c29087
WEB_SEARCH_CONTEXT_REGISTRY_MAX = 80

# split-source: order=124 original-lines=205-205 hash=e7001f0ab1908461
WEB_SEARCH_CONTEXT_PROMPT_MAX_ITEMS = 4

# split-source: order=125 original-lines=206-206 hash=46c79dbe876edf7d
WEB_SEARCH_CONTEXT_PROMPT_MAX_CHARS = 3_200

# split-source: order=126 original-lines=207-207 hash=19a8758020b0287f
WEB_SEARCH_CONTEXT_NODE_MAX = 18

# split-source: order=127 original-lines=208-208 hash=aa4f67667523a908
WEB_SEARCH_CONTEXT_URL_MAX = 12

# split-source: order=128 original-lines=209-209 hash=aaf2fa5cd0810b8f
RAG_CHUNK_CHARS = 1200

# split-source: order=129 original-lines=210-210 hash=309ddd6d99043a56
RAG_CHUNK_OVERLAP = 180

# split-source: order=130 original-lines=211-213 hash=cbc0bc1b1ec764d8
...
# split-source: order=131 original-lines=214-224 hash=f9665580fd1c5daf
...
# split-source: order=135 original-lines=228-228 hash=9f810d660d111af5
RAG_MAX_QUERY_RESULTS = 64

# split-source: order=136 original-lines=229-229 hash=85b3ffab92dc6826
RAG_HIGH_RECALL_POOL_MULTIPLIER = 4

# split-source: order=137 original-lines=230-230 hash=e6f0dbdcee02aefa
RAG_HIGH_RECALL_MIN_POOL = 64

# split-source: order=138 original-lines=231-231 hash=25da11c02b0cf298
RAG_RETRIEVAL_MAX_PER_DOC = 5

# split-source: order=139 original-lines=232-235 hash=6841816deefd0ee6
...
# split-source: order=140 original-lines=236-236 hash=2d171a12f2a2b0df
RAG_BM25_B = 0.6

# split-source: order=141 original-lines=237-243 hash=8e22666a18931d46
...
# split-source: order=142 original-lines=244-247 hash=7f661449fcaa2f49
...
# split-source: order=143 original-lines=248-251 hash=1d7d116b3609a122
...
# split-source: order=144 original-lines=252-252 hash=5d991f69eabf4d86
RAG_GRAPH_MAX_NODES = 2000

# split-source: order=145 original-lines=253-253 hash=d12a174d6fd9e3d1
RAG_TASK_HISTORY_LIMIT = 400

# split-source: order=146 original-lines=254-254 hash=dee63d928b5da55d
RAG_MODEL_MEDIA_MAX_BYTES = 8 * 1024 * 1024

# split-source: order=147 original-lines=255-255 hash=0bd03a6d3e7f0f2e
RAG_MAX_IMPORT_FILES = 20_000

# split-source: order=148 original-lines=256-256 hash=0210661dff3213bd
RAG_MAX_IMPORT_BATCH_ITEMS = 500

# split-source: order=149 original-lines=257-257 hash=1280f2f93657c8ec
RAG_MAX_IMPORT_BATCH_BYTES = 48 * 1024 * 1024

# split-source: order=150 original-lines=258-258 hash=9b16447b85b735a1
RAG_PDF_IMAGE_LIMIT = 8

# split-source: order=151 original-lines=259-259 hash=da5178fecc5cbb0b
RAG_QUERY_CONTEXT_CHARS = 1600

# split-source: order=152 original-lines=260-260 hash=ad9a742e3b013a67
RAG_MAX_GLOBAL_COMMUNITIES = 3

# split-source: order=153 original-lines=261-261 hash=4bbc8f3a1ecc50a5
RAG_MAX_COMMUNITY_MAP_SUPPORT = 4

# split-source: order=154 original-lines=262-262 hash=549e954ad7f48ea0
RAG_INCLUDE_FILENAME_ENTITIES_DEFAULT = False

# split-source: order=155 original-lines=263-263 hash=2bc7d7e718aba97c
RAG_DYNAMIC_NOISE_MIN_DOC_FREQ = 6

# split-source: order=156 original-lines=264-264 hash=733eefaf02668c28
RAG_DYNAMIC_NOISE_MIN_COMMUNITY_FREQ = 2

# split-source: order=157 original-lines=265-265 hash=e6e6f84055bb3023
RAG_DYNAMIC_NOISE_SOFT_DOC_RATIO = 0.18

# split-source: order=158 original-lines=266-266 hash=1f390b7adea12881
RAG_DYNAMIC_NOISE_HARD_DOC_RATIO = 0.42

# split-source: order=159 original-lines=267-267 hash=ffb33a9079f79edb
RAG_DYNAMIC_NOISE_SOFT_COMMUNITY_RATIO = 0.46

# split-source: order=160 original-lines=268-268 hash=c1f3ed654aa13e2e
RAG_DYNAMIC_NOISE_HARD_COMMUNITY_RATIO = 0.80

# split-source: order=161 original-lines=269-269 hash=610fab1edd200089
RAG_MIN_SYNTHESIS_SCORE = 0.12       # chunks below this score are filtered before LLM synthesis

# split-source: order=162 original-lines=270-270 hash=92ad3654a044311c
RAG_NO_EVIDENCE_THRESHOLD = 0.18     # if best chunk score < this, skip LLM entirely and return no-evidence message

# split-source: order=163 original-lines=271-271 hash=b41ef5fe5a88a655
RAG_WEAK_MATCH_SCORE_CAP = 0.095     # fuzzy fallback candidates stay visible but cannot trigger grounded synthesis

# split-source: order=164 original-lines=272-272 hash=5c1d29556c1d9c54
RAG_SYNTHESIS_MAX_PER_DOC = 2        # max chunks from the same document in synthesis evidence

# split-source: order=165 original-lines=273-273 hash=d9cf5b5fb75012f3
RAG_WORKFLOW_ACCEPT_SCORE = 0.72

# split-source: order=166 original-lines=274-274 hash=be24078cca77958b
RAG_NO_EVIDENCE_MESSAGE = "知识库中暂无足够证据回答此问题。请尝试扩展查询范围或导入相关文档。"

# split-source: order=167 original-lines=275-279 hash=9a8108a254df24cc
RAG_CONTEXT_BUDGETS = {
...
# split-source: order=168 original-lines=280-280 hash=47e19cb979054ec1
RAG_WEAK_EVIDENCE_MESSAGE = "知识库命中了相关材料，但证据强度不足以可靠回答。以下仅返回可核查的候选证据。"

# split-source: order=169 original-lines=281-281 hash=25f028f81020ec5c
RAG_DENSE_DEFAULT_ENABLED = str(os.getenv("AGENT_RAG_DENSE_DEFAULT", "false") or "false").strip().lower() in {"1", "true", "yes", "on"}

# split-source: order=170 original-lines=282-282 hash=1376830a693ad1b8
RAG_EMBEDDING_MODE_VALUES = {"off", "sparse", "tfidf", "dense", "hybrid"}

# split-source: order=171 original-lines=283-286 hash=35a7b18dbc7431ea
RAG_IMPORT_WORKER_COUNT = max(
    1,
    min(4, int(str(os.getenv("AGENT_RAG_IMPORT_WORKERS", "2") or "2"))),
)

# split-source: order=173 original-lines=291-294 hash=58a3791de9558c47
RAG_PARSE_TIMEOUT_SECONDS = max(
    15,
    min(240, int(str(os.getenv("AGENT_RAG_PARSE_TIMEOUT", "75") or "75"))),
)

# split-source: order=792 original-lines=77676-82309 hash=3cf5127aba1f993e
...
# split-source: order=793 original-lines=82310-82331 hash=16c96d4b2d9ea8e8
RAG_RESEARCH_HINTS = (
    "abstract",
    "introduction",
    "related work",
...
# split-source: order=794 original-lines=82332-82342 hash=636311fb17640a4e
RAG_CODE_HINTS = (
    "def ",
    "class ",
    "import ",
...
# split-source: order=795 original-lines=82343-82358 hash=4605c77eed589f3f
...
# split-source: order=796 original-lines=82359-82431 hash=527026fadb463036
RAG_EN_STOPWORDS = {
    "a",
    "an",
    "and",
...
# split-source: order=797 original-lines=82432-82468 hash=7523a7a144f1f7c8
RAG_ZH_STOPWORDS = {
    "一个",
    "一种",
    "一些",
...
# split-source: order=798 original-lines=82469-82547 hash=fffc05a6e73ad1f0
...
# split-source: order=799 original-lines=82548-82590 hash=cd605de6a86d441a
...
# split-source: order=800 original-lines=82591-82609 hash=e90fa9ad0c5a4f61
...
# split-source: order=825 original-lines=83354-83363 hash=bca531e8850a5266
...
# split-source: order=826 original-lines=83364-83420 hash=bc72eba2e2dbde18
...
# split-source: order=827 original-lines=83421-83427 hash=9de27595b7cb2425
