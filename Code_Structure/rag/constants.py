...
# split-source: order=108 original-lines=230-230 hash=0de182d69186f310
RAG_LIBRARY_DIRNAME = "RAG_Library"

# split-source: order=109 original-lines=231-231 hash=1c1e1de533d243c7
RAG_ADMIN_PORT_OFFSET = 2

# split-source: order=110 original-lines=232-232 hash=c0f0809a695fc9d1
CODE_LIBRARY_DIRNAME = "Code_Library"

# split-source: order=115 original-lines=240-240 hash=15ac97b37116e7af
WEB_SEARCH_INDEX_DIRNAME = "Web_Search_Index"

# split-source: order=117 original-lines=242-242 hash=a03862a542a37ae6
USER_MEMORY_DIRNAME = ".clouds_coder"

# split-source: order=118 original-lines=243-243 hash=f9d6faf310172e3d
USER_MEMORY_DB_FILENAME = "user_memory.sqlite"

# split-source: order=119 original-lines=244-244 hash=febd58a2c34ffb3d
USER_MEMORY_PROFILE_FILENAME = "user_profile.json"

# split-source: order=120 original-lines=245-245 hash=8f0b97463a93304a
USER_MEMORY_MODE_CHOICES = {"off", "weak", "on"}

# split-source: order=122 original-lines=247-247 hash=72466feef8186fb8
USER_MEMORY_WEAK_CAPSULE_CHARS = 1200

# split-source: order=123 original-lines=248-248 hash=5512298c89436343
USER_MEMORY_ON_CAPSULE_CHARS = 2200

# split-source: order=124 original-lines=249-252 hash=acd37ce36c51b613
...
# split-source: order=125 original-lines=253-253 hash=c5722113df436b0f
USER_MEMORY_MAX_SUMMARY_CHARS = 1200

# split-source: order=126 original-lines=254-254 hash=b23bc08397e51a50
USER_MEMORY_QUERY_LIMIT = 8

# split-source: order=127 original-lines=255-255 hash=42789d8e57098529
USER_MEMORY_DECAY_HALFLIFE_DAYS = 45.0

# split-source: order=128 original-lines=256-256 hash=25a72ca204adb0bf
USER_MEMORY_PROFILE_SCHEMA_VERSION = 1

# split-source: order=139 original-lines=267-267 hash=05e40a7a15c29087
WEB_SEARCH_CONTEXT_REGISTRY_MAX = 80

# split-source: order=140 original-lines=268-268 hash=e7001f0ab1908461
WEB_SEARCH_CONTEXT_PROMPT_MAX_ITEMS = 4

# split-source: order=141 original-lines=269-269 hash=46c79dbe876edf7d
WEB_SEARCH_CONTEXT_PROMPT_MAX_CHARS = 3_200

# split-source: order=142 original-lines=270-270 hash=19a8758020b0287f
WEB_SEARCH_CONTEXT_NODE_MAX = 18

# split-source: order=143 original-lines=271-271 hash=aa4f67667523a908
WEB_SEARCH_CONTEXT_URL_MAX = 12

# split-source: order=144 original-lines=272-272 hash=aaf2fa5cd0810b8f
RAG_CHUNK_CHARS = 1200

# split-source: order=145 original-lines=273-273 hash=309ddd6d99043a56
RAG_CHUNK_OVERLAP = 180

# split-source: order=146 original-lines=274-276 hash=cbc0bc1b1ec764d8
...
# split-source: order=147 original-lines=277-287 hash=f9665580fd1c5daf
...
# split-source: order=151 original-lines=291-291 hash=9f810d660d111af5
RAG_MAX_QUERY_RESULTS = 64

# split-source: order=152 original-lines=292-292 hash=85b3ffab92dc6826
RAG_HIGH_RECALL_POOL_MULTIPLIER = 4

# split-source: order=153 original-lines=293-293 hash=e6f0dbdcee02aefa
RAG_HIGH_RECALL_MIN_POOL = 64

# split-source: order=154 original-lines=294-294 hash=25da11c02b0cf298
RAG_RETRIEVAL_MAX_PER_DOC = 5

# split-source: order=155 original-lines=295-298 hash=6841816deefd0ee6
...
# split-source: order=156 original-lines=299-299 hash=2d171a12f2a2b0df
RAG_BM25_B = 0.6

# split-source: order=157 original-lines=300-306 hash=8e22666a18931d46
...
# split-source: order=158 original-lines=307-310 hash=7f661449fcaa2f49
...
# split-source: order=159 original-lines=311-314 hash=1d7d116b3609a122
...
# split-source: order=160 original-lines=315-315 hash=5d991f69eabf4d86
RAG_GRAPH_MAX_NODES = 2000

# split-source: order=161 original-lines=316-316 hash=d12a174d6fd9e3d1
RAG_TASK_HISTORY_LIMIT = 400

# split-source: order=162 original-lines=317-317 hash=dee63d928b5da55d
RAG_MODEL_MEDIA_MAX_BYTES = 8 * 1024 * 1024

# split-source: order=163 original-lines=318-318 hash=0bd03a6d3e7f0f2e
RAG_MAX_IMPORT_FILES = 20_000

# split-source: order=164 original-lines=319-319 hash=0210661dff3213bd
RAG_MAX_IMPORT_BATCH_ITEMS = 500

# split-source: order=165 original-lines=320-320 hash=1280f2f93657c8ec
RAG_MAX_IMPORT_BATCH_BYTES = 48 * 1024 * 1024

# split-source: order=166 original-lines=321-321 hash=9b16447b85b735a1
RAG_PDF_IMAGE_LIMIT = 8

# split-source: order=167 original-lines=322-322 hash=da5178fecc5cbb0b
RAG_QUERY_CONTEXT_CHARS = 1600

# split-source: order=168 original-lines=323-323 hash=ad9a742e3b013a67
RAG_MAX_GLOBAL_COMMUNITIES = 3

# split-source: order=169 original-lines=324-324 hash=4bbc8f3a1ecc50a5
RAG_MAX_COMMUNITY_MAP_SUPPORT = 4

# split-source: order=170 original-lines=325-325 hash=549e954ad7f48ea0
RAG_INCLUDE_FILENAME_ENTITIES_DEFAULT = False

# split-source: order=171 original-lines=326-326 hash=2bc7d7e718aba97c
RAG_DYNAMIC_NOISE_MIN_DOC_FREQ = 6

# split-source: order=172 original-lines=327-327 hash=733eefaf02668c28
RAG_DYNAMIC_NOISE_MIN_COMMUNITY_FREQ = 2

# split-source: order=173 original-lines=328-328 hash=e6e6f84055bb3023
RAG_DYNAMIC_NOISE_SOFT_DOC_RATIO = 0.18

# split-source: order=174 original-lines=329-329 hash=1f390b7adea12881
RAG_DYNAMIC_NOISE_HARD_DOC_RATIO = 0.42

# split-source: order=175 original-lines=330-330 hash=ffb33a9079f79edb
RAG_DYNAMIC_NOISE_SOFT_COMMUNITY_RATIO = 0.46

# split-source: order=176 original-lines=331-331 hash=c1f3ed654aa13e2e
RAG_DYNAMIC_NOISE_HARD_COMMUNITY_RATIO = 0.80

# split-source: order=177 original-lines=332-332 hash=610fab1edd200089
RAG_MIN_SYNTHESIS_SCORE = 0.12       # chunks below this score are filtered before LLM synthesis

# split-source: order=178 original-lines=333-333 hash=92ad3654a044311c
RAG_NO_EVIDENCE_THRESHOLD = 0.18     # if best chunk score < this, skip LLM entirely and return no-evidence message

# split-source: order=179 original-lines=334-334 hash=b41ef5fe5a88a655
RAG_WEAK_MATCH_SCORE_CAP = 0.095     # fuzzy fallback candidates stay visible but cannot trigger grounded synthesis

# split-source: order=180 original-lines=335-335 hash=5c1d29556c1d9c54
RAG_SYNTHESIS_MAX_PER_DOC = 2        # max chunks from the same document in synthesis evidence

# split-source: order=181 original-lines=336-336 hash=d9cf5b5fb75012f3
RAG_WORKFLOW_ACCEPT_SCORE = 0.72

# split-source: order=182 original-lines=337-337 hash=be24078cca77958b
RAG_NO_EVIDENCE_MESSAGE = "知识库中暂无足够证据回答此问题。请尝试扩展查询范围或导入相关文档。"

# split-source: order=183 original-lines=338-342 hash=9a8108a254df24cc
RAG_CONTEXT_BUDGETS = {
...
# split-source: order=184 original-lines=343-343 hash=47e19cb979054ec1
RAG_WEAK_EVIDENCE_MESSAGE = "知识库命中了相关材料，但证据强度不足以可靠回答。以下仅返回可核查的候选证据。"

# split-source: order=185 original-lines=344-344 hash=25f028f81020ec5c
RAG_DENSE_DEFAULT_ENABLED = str(os.getenv("AGENT_RAG_DENSE_DEFAULT", "false") or "false").strip().lower() in {"1", "true", "yes", "on"}

# split-source: order=186 original-lines=345-345 hash=1376830a693ad1b8
RAG_EMBEDDING_MODE_VALUES = {"off", "sparse", "tfidf", "dense", "hybrid"}

# split-source: order=187 original-lines=346-349 hash=35a7b18dbc7431ea
RAG_IMPORT_WORKER_COUNT = max(
    1,
    min(4, int(str(os.getenv("AGENT_RAG_IMPORT_WORKERS", "2") or "2"))),
)

# split-source: order=189 original-lines=354-357 hash=58a3791de9558c47
RAG_PARSE_TIMEOUT_SECONDS = max(
    15,
    min(240, int(str(os.getenv("AGENT_RAG_PARSE_TIMEOUT", "75") or "75"))),
)

# split-source: order=883 original-lines=82260-86893 hash=3cf5127aba1f993e
...
# split-source: order=884 original-lines=86894-86915 hash=16c96d4b2d9ea8e8
RAG_RESEARCH_HINTS = (
    "abstract",
    "introduction",
    "related work",
...
# split-source: order=885 original-lines=86916-86926 hash=636311fb17640a4e
RAG_CODE_HINTS = (
    "def ",
    "class ",
    "import ",
...
# split-source: order=886 original-lines=86927-86942 hash=4605c77eed589f3f
...
# split-source: order=887 original-lines=86943-87015 hash=527026fadb463036
RAG_EN_STOPWORDS = {
    "a",
    "an",
    "and",
...
# split-source: order=888 original-lines=87016-87052 hash=7523a7a144f1f7c8
RAG_ZH_STOPWORDS = {
    "一个",
    "一种",
    "一些",
...
# split-source: order=889 original-lines=87053-87131 hash=fffc05a6e73ad1f0
...
# split-source: order=890 original-lines=87132-87174 hash=cd605de6a86d441a
...
# split-source: order=891 original-lines=87175-87193 hash=e90fa9ad0c5a4f61
...
# split-source: order=916 original-lines=87938-87947 hash=bca531e8850a5266
...
# split-source: order=917 original-lines=87948-88004 hash=bc72eba2e2dbde18
...
# split-source: order=918 original-lines=88005-88011 hash=9de27595b7cb2425
