...
# split-source: order=701 original-lines=9078-9091 hash=31577b90e3bcda44
...
# split-source: order=702 original-lines=9092-9102 hash=6c03436acef9b8b8
...
# split-source: order=707 original-lines=9109-9140 hash=72ddb18177d751e6
...
# split-source: order=708 original-lines=9141-9189 hash=22a7c9af9a04af7d
...
# split-source: order=801 original-lines=82612-82626 hash=f15af64ee0ad858d
...
# split-source: order=802 original-lines=82627-82643 hash=8256f8af0f0c3e33
...
# split-source: order=803 original-lines=82644-82658 hash=ae335b203709f25e
...
# split-source: order=804 original-lines=82659-82680 hash=a509f4e26bf3379b
...
# split-source: order=805 original-lines=82681-82695 hash=49c94bd89926670a
...
# split-source: order=806 original-lines=82696-82712 hash=8f77ad80b84a7ae2
...
# split-source: order=807 original-lines=82713-82748 hash=d4f514f469978213
...
# split-source: order=808 original-lines=82749-82781 hash=2b67aafb5ee5a63a
...
# split-source: order=809 original-lines=82782-82821 hash=10463c89f0201e79
...
# split-source: order=813 original-lines=82890-82943 hash=5f2e46a51c494145
...
# split-source: order=814 original-lines=82944-82967 hash=a906665e32db82b6
...
# split-source: order=815 original-lines=82968-82986 hash=704c7d12a398a746
...
# split-source: order=816 original-lines=82987-83023 hash=e0a07466be3508a1
...
# split-source: order=824 original-lines=83276-83355 hash=b684cb74bf98083c
...
# split-source: order=828 original-lines=83430-83448 hash=72f6c82513a4c799
...
# split-source: order=829 original-lines=83449-83453 hash=28e4542ecc7f6d38
...
# split-source: order=833 original-lines=83496-83510 hash=66418ff2b69e755d
...
# split-source: order=834 original-lines=83511-83513 hash=a19cb208aec4ce1c


_ALGO_COMPLEXITY_RE = re.compile(r"O\s*\(\s*(?:n|log|1|n\^2|n²|n\s*\*)", re.IGNORECASE)

# split-source: order=835 original-lines=83514-83514 hash=4a246044d3169bfe
_ALGO_STEP_RE = re.compile(r"#\s*(?:step|phase|algorithm|算法|步骤)\s*\d*[:：\s]", re.IGNORECASE)

# split-source: order=836 original-lines=83515-83515 hash=11a327683a15c351
_ALGO_MATH_VARS = frozenset(["alpha", "beta", "gamma", "epsilon", "theta", "delta", "lambda", "mu", "sigma", "omega"])

# split-source: order=837 original-lines=83516-83516 hash=247850f225a77823
_ALGO_DOC_KEYWORDS = frozenset(["algorithm", "complexity", "iterate", "convergence", "converge", "算法", "复杂度", "迭代"])

# split-source: order=838 original-lines=83517-83542 hash=f4c89ff5d85d4942
...
# split-source: order=839 original-lines=83543-84052 hash=801414aaa33e2e5f
...
# split-source: order=840 original-lines=84053-84562 hash=0ddc01ce49e87b6a
