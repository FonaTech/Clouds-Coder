...
# split-source: order=1175 original-lines=116935-116952 hash=58c9260037425107
...
# split-source: order=1176 original-lines=116953-116953 hash=96e8c851e2302159
STUDIO_SESSION_COOKIE = "cc_studio_session"

# split-source: order=1177 original-lines=116954-116954 hash=d6411ff144d2b2e9
STUDIO_DEVICE_TTL = 180 * 24 * 60 * 60

# split-source: order=1178 original-lines=116955-116955 hash=955afcde4cb400ac
STUDIO_SESSION_TTL = 24 * 60 * 60

# split-source: order=1179 original-lines=116956-116956 hash=569c087422548fbf
STUDIO_MAX_FILE_BYTES = 10 * 1024 * 1024

# split-source: order=1180 original-lines=116957-116957 hash=a9fdb060d056c458
STUDIO_MAX_PROJECT_BYTES = 50 * 1024 * 1024

# split-source: order=1181 original-lines=116958-116958 hash=349eab79a6a7f9a7
STUDIO_MAX_FILES = 256

# split-source: order=1182 original-lines=116959-116959 hash=1f1795a6e43689f3
STUDIO_MAX_JOB_SECONDS = 15 * 60

# split-source: order=1188 original-lines=118858-118860 hash=f4c00c1faeb747fb
...
# split-source: order=1189 original-lines=118861-118861 hash=4b782b7dd294d57e
...
# split-source: order=1190 original-lines=118862-118862 hash=ca9a737435a250bf
