...
# split-source: order=836 original-lines=14908-14910 hash=fe64e14cf82a6abb


TABULAR_PREVIEW_EXTS = {".csv", ".tsv"}

# split-source: order=837 original-lines=14911-14911 hash=43ed1e050832d382
EXCEL_PREVIEW_EXTS = {".xlsx", ".xls", ".xlsm"}

# split-source: order=838 original-lines=14912-14912 hash=41505360f13ba6a7
PRESENTATION_PREVIEW_EXTS = {".pptx", ".ppt", ".pptm"}

# split-source: order=839 original-lines=14913-14913 hash=8d36725f2e52a335
DOCUMENT_PREVIEW_EXTS = {".docx", ".doc", ".docm"}

# split-source: order=1041 original-lines=106575-106592 hash=58c9260037425107
...
# split-source: order=1042 original-lines=106593-106593 hash=96e8c851e2302159
STUDIO_SESSION_COOKIE = "cc_studio_session"

# split-source: order=1043 original-lines=106594-106594 hash=d6411ff144d2b2e9
STUDIO_DEVICE_TTL = 180 * 24 * 60 * 60

# split-source: order=1044 original-lines=106595-106595 hash=955afcde4cb400ac
STUDIO_SESSION_TTL = 24 * 60 * 60

# split-source: order=1045 original-lines=106596-106596 hash=569c087422548fbf
STUDIO_MAX_FILE_BYTES = 10 * 1024 * 1024

# split-source: order=1046 original-lines=106597-106597 hash=a9fdb060d056c458
STUDIO_MAX_PROJECT_BYTES = 50 * 1024 * 1024

# split-source: order=1047 original-lines=106598-106598 hash=349eab79a6a7f9a7
STUDIO_MAX_FILES = 256

# split-source: order=1048 original-lines=106599-106599 hash=1f1795a6e43689f3
STUDIO_MAX_JOB_SECONDS = 15 * 60

# split-source: order=1054 original-lines=108499-108501 hash=f4c00c1faeb747fb
...
# split-source: order=1055 original-lines=108502-108502 hash=4b782b7dd294d57e
...
# split-source: order=1056 original-lines=108503-108503 hash=ca9a737435a250bf
