...
# split-source: order=1041 original-lines=106551-106568 hash=58c9260037425107
...
# split-source: order=1042 original-lines=106569-106569 hash=96e8c851e2302159
STUDIO_SESSION_COOKIE = "cc_studio_session"

# split-source: order=1043 original-lines=106570-106570 hash=d6411ff144d2b2e9
STUDIO_DEVICE_TTL = 180 * 24 * 60 * 60

# split-source: order=1044 original-lines=106571-106571 hash=955afcde4cb400ac
STUDIO_SESSION_TTL = 24 * 60 * 60

# split-source: order=1045 original-lines=106572-106572 hash=569c087422548fbf
STUDIO_MAX_FILE_BYTES = 10 * 1024 * 1024

# split-source: order=1046 original-lines=106573-106573 hash=a9fdb060d056c458
STUDIO_MAX_PROJECT_BYTES = 50 * 1024 * 1024

# split-source: order=1047 original-lines=106574-106574 hash=349eab79a6a7f9a7
STUDIO_MAX_FILES = 256

# split-source: order=1048 original-lines=106575-106575 hash=1f1795a6e43689f3
STUDIO_MAX_JOB_SECONDS = 15 * 60

# split-source: order=1054 original-lines=108475-108477 hash=f4c00c1faeb747fb
...
# split-source: order=1055 original-lines=108478-108478 hash=4b782b7dd294d57e
...
# split-source: order=1056 original-lines=108479-108479 hash=ca9a737435a250bf
